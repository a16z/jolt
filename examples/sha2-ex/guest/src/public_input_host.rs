...
pub fn build_prover_sha2(
    ...
    let prove_closure = move |public_input: &[u8], second_input: [u8; 32]| {
...
pub fn build_verifier_sha2(
        ...
        proof: jolt::RV64IMACJoltProof|
    {
        ...
        io_device.inputs.append(&mut jolt::postcard::to_stdvec(&second_input).unwrap());
...
pub fn prove_sha2(
    ...
    input_bytes.append(&mut jolt::postcard::to_stdvec(&second_input).unwrap());
