...
// NOTE: Due to a dory-pcs v0.1.0 limitation, only one provable function can be
// tested per process. The dory cache (OnceCell) locks to the first setup size.
// Comment/uncomment tests one at a time to run them individually.
