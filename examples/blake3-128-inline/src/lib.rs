...
#[jolt::provable]
fn blake3_128_inline(input: [u8; 32], num_iters: u32) -> [u32; 8] {
    // Create hash = input repeated 32 times to fill 1024 bytes (32 * 32 = 1024)
    let input = black_box(b"sjfkisiwq8mc1afioc21spaqk118akcoiwvaahd1wiu3e112bnjkq97qou9u21qwsjfkisiwq8mc1afioc21spaqk118akcoiwvaahd1wiu3e112bnjkq97qou9u21qw");
    ...
    for _ in 0..black_box(num_iters) {
        unsafe {
            blake3::blake3_hash_128(black_box(h.as_mut_ptr()), black_box(message.as_ptr()));
        }
