...
pub fn main() {
    ...
    let verifier_preprocessing = guest::preprocess_verifier_add(
    ...
    let verifier_preprocessing = guest::preprocess_verifier_mul(shared_preprocessing, prover_preprocessing.generators.to_verifier_setup());
