...
The post-rebase locked real gate measured **27.792 s -> 26.072 s** honest online wall,
**7.140 s -> 6.233 s** phase-2a commitment, and **1.910 s -> 2.637 s** T2
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 4 | 17 | 62 / 2 | 6 / 5 | 167 | **6.233 s M** | **2.637 s M** | **26.072 s M** | **7,392 / 7,529 B M** | **4,890,645 M** | chosen |
| 6 | 11 | 56 / 2 | 8 / 7 | 155 | 5.630 s E | 3.537 s E | 26.368 s E | 7,456 / 7,593 B E | 4,953,029 E | +64 B |
| 9 | 8 | 53 / 2 | 11 / 10 | 149 | 5.328 s E | 4.922 s E | 27.452 s E | 7,552 / 7,689 B E | 5,046,605 E | +160 B, slower |
...
The before column is the final lane-3 gate. The post-rebase gate acquired the
lock after a 10-minute gap and a prebuild, at command-start load 2.84; the
honest clock load was 4.34 -> 5.90. The pre-rebase replicate measured
26.624 s wall, 6.227 s phase 2a, and 2.700 s T2 stage A at command-start load
2.77 and honest-clock load 3.95 -> 6.83.

| phase | s=3 | s=4 | delta |
|---|---:|---:|---:|
| wrapper preparation | 454 ms | 437 ms | -17 ms |
| T1/R stream adaptation | 73 ms | 70 ms | -3 ms |
| T2 adaptation | 640 ms | 643 ms | +3 ms |
| phase 1a commitment | 778 ms | 772 ms | -6 ms |
| T2 phase 1b commitment | 966 ms | 1,002 ms | +36 ms |
| T2 phase 2a commitment | 7,140 ms | 6,233 ms | **-907 ms** |
| T2 phase 2b commitment | 116 ms | 98 ms | -18 ms |
| CopyLink helpers | 37 ms | 35 ms | -2 ms |
| T2 phase 2c + helpers | 372 ms | 367 ms | -5 ms |
| T2 finish | 457 ms | 320 ms | -137 ms |
| all member constructors | 785 ms | 791 ms | +6 ms |
| proof stages/opening | 15,968 ms | 15,298 ms | -670 ms |
| T2 stage-A row member | 1,910 ms | 2,637 ms | **+727 ms** |
| **honest online wall** | **27,792 ms** | **26,072 ms** | **-1,720 ms** |
| process CPU | 219.040 s | 217.560 s | -1.480 s |
| CPU / wall | 7.881 | 8.345 | +0.464 |
