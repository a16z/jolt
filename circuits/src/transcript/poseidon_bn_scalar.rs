...
//     let mut initial_state: Vec<Scalar> = Vec::new();
//     for _ in 0..STATE_WIDTH{
//         initial_state.push(Scalar::rand(&mut rng));
//     }
//     let params =
//             get_poseidon_parameters::<Scalar>(4, PoseidonDefaultConfigEntry::new(4, 5, 8, 56, 0))
//                 .unwrap();

//     let mut poseidon_sponge = PoseidonSponge::<Scalar>::new(&params);
...
//         for i in 0..5{
//             circom_result.push(Scalar::from(result[i].clone()))
//         }
...
// pub struct GrumpkinBaseArray{
//     pub state: Vec<GrumpkinBase>
// }
// impl fmt::Debug for GrumpkinBaseArray {
//     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
//         write!(
//             f,
//             r#"[
...
// #[test]
// fn poseidon_grumpkin_base(){
//     let mut rng = ark_std::test_rng();
    
//     let mut initial_state: Vec<GrumpkinBase> = Vec::new();
//     for _ in 0..STATE_WIDTH{
//         initial_state.push(GrumpkinBase::rand(&mut rng));
//     }
//     let params =
//             get_poseidon_parameters::<GrumpkinBase>(4, PoseidonDefaultConfigEntry::new(4, 5, 8, 56, 0))
//                 .unwrap();

//     let mut poseidon_sponge = PoseidonSponge::<GrumpkinBase>::new(&params);
//     poseidon_sponge.state = initial_state.clone();

//     assert_eq!(poseidon_sponge.state.len(), STATE_WIDTH);

//     let initial_state_arr = GrumpkinBaseArray{state: initial_state};
//     let input_json = format!(
//         r#"{{
//         "state": {:?}
//     }}"#,
...
//         let mut circom_result = Vec::new();
//         for i in 0..5{
//             circom_result.push(GrumpkinBase::from(result[i].clone()))
//         }
