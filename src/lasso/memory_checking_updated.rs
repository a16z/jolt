...
pub struct MemoryCheckingProofUpdated<G: CurveGroup, S: MemCheckingStrat<G>> {
...
impl<G: CurveGroup, S: MemCheckingStrat<G>> MemoryCheckingProofUpdated<G, S> {
  pub fn prove(
