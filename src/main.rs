...
[patch.crates-io]
ark-ff = { git = "https://github.com/andrewmilson/algebra", branch = "dev/twist-shout" }
ark-ec = { git = "https://github.com/andrewmilson/algebra", branch = "dev/twist-shout" }
ark-serialize = { git = "https://github.com/andrewmilson/algebra", branch = "dev/twist-shout" }
ark-bn254 = { git = "https://github.com/andrewmilson/algebra", branch = "dev/twist-shout" }
"#;
