...
| Representative transfer, no observed per-workload regression | BTreeMap27.610286->27.089531s,both verified; SHA2/SHA3/Collatz pending | Pending |
| >=3% higher arithmetic-mean MHz across five | Requires remaining three transfer pairs | Pending |
