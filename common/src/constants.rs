...
pub const INPUT_END_ADDRESS: u64 = 0x200000FF;
pub const OUTPUT_START_ADDRESS: u64 = 0x20000100;
pub const OUTPUT_END_ADDRESS: u64 = 0x200001FF;
pub const PANIC_ADDRESS: u64 = 0x20000200;
