...
use crate::jolt::instruction::{
    add::ADDInstruction, and::ANDInstruction, sll::SLLVirtualSequence, srl::SRLVirtualSequence,
...
impl<const WORD_SIZE: usize> VirtualInstructionSequence for LBUInstruction<WORD_SIZE> {
    ...
    fn virtual_trace(trace_row: RVTraceRow) -> Vec<RVTraceRow> {
        ...
        let zero_extended_byte =
            SRLVirtualSequence::<WORD_SIZE>::sequence_output(left_aligned_byte, 24);
        ...
        virtual_trace.extend(SRLVirtualSequence::<WORD_SIZE>::virtual_trace(srl));
