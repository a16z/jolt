...
#[macro_export]
macro_rules! par_join_7 {
    ($task1:expr, $task2:expr, $task3:expr, $task4:expr, $task5:expr, $task6:expr, $task7:expr) => {{
        let (((result1, result2), (result3, result4)), ((result5, result6), result7)) = rayon::join(
            || {
                rayon::join(
                    || rayon::join($task1, $task2),
            ...
            || rayon::join(|| rayon::join($task5, $task6), $task7),
        );
        (
