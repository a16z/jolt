...
- Prepared-point cache initialization now prepares G1 and G2 points in parallel
  and builds replacements outside the global cache write lock.
...
[0.4.2]: https://github.com/a16z/dory/compare/v0.4.1...v0.4.2
[0.4.1]: https://github.com/a16z/dory/compare/v0.4.0...v0.4.1
