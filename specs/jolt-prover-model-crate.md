...
- `jolt-verifier` is the primary acceptance oracle as the prover path grows.
...
- each implemented prover path is accepted by the matching `jolt-verifier`
  path;
...
require the corresponding verifier stage/prover path to accept it. `jolt-core`
