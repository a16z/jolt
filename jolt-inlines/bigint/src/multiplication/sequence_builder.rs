use jolt_inlines_sdk::host::{
    ...
    InlineRegister, NoAdvice, SourceInstructionKind,
};
...
impl BigIntMulSequenceBuilder {
    ...
    fn build(mut self) -> Result<ExpandedInstructionSequence, ExpansionError> {
        ...
        self.asm
            .emit_r(SourceInstructionKind::MUL, self.s(0), self.a(0), self.b(0));
        self.asm
            .emit_s(SourceInstructionKind::SD, self.operands.rs3, self.s(0), 0); // Store 0th limb immediately
            ...
            for i in 0..INPUT_LIMBS {
                for j in 0..INPUT_LIMBS {
                    ...
                    if i + j == k {
                        ...
                        self.asm
                            .emit_r(SourceInstructionKind::MUL, self.t(), self.a(i), self.b(j));
                    ...
                    if i + j == k || i + j == k - 1 {
                        ...
                        self.asm
                            .emit_r(SourceInstructionKind::ADD, self.s(k), self.s(k), self.t());
