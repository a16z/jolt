...
mod tests {
    ...
    #[test]
    fn test_blake2b_inline_sequence_builder_instruction_count() {
        use super::blake2b_inline_sequence_builder;
        ...
        let instructions = blake2b_inline_sequence_builder(asm, operands);
        
        // Get the length of the instruction sequence
        let instruction_count = instructions.len();
        
        // Print the instruction count for visibility
        println!("BLAKE2b inline sequence generated {} instructions", instruction_count);
        ...
        // Assert that we generated a reasonable number of instructions for BLAKE2b compression
        // BLAKE2b compression involves rounds with multiple operations per round
        assert!(instruction_count > 100, "Expected more than 100 instructions for BLAKE2b compression");
        
        println!("Test passed: Generated {} instructions for BLAKE2b compression", instruction_count);
    }
}
