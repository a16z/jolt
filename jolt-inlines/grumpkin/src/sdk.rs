...
impl jolt_inlines_common::ec::ECField for GrumpkinFq {
...
impl jolt_inlines_common::ec::CurveParams<GrumpkinFq> for GrumpkinCurve {
    type Error = GrumpkinError;
...
pub type GrumpkinPoint = jolt_inlines_common::ec::AffinePoint<GrumpkinFq, GrumpkinCurve>;
