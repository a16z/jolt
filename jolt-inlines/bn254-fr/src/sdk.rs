...
#[expect(
    clippy::panic,
    reason = "Stub for non-RISC-V, non-host targets — Fr arithmetic is not \
              available without the host feature; loud panic beats silent \
              miscompile."
)]
...
#[expect(
    clippy::panic,
    reason = "Stub for non-RISC-V, non-host targets — see binary_op above."
)]
