...
mod tests {
    #[test]
    fn test_keccak256_inline_sequence_builder_instruction_count() {
        use super::keccak256_inline_sequence_builder;
        ...
        let instructions = keccak256_inline_sequence_builder(asm, operands);
        
        // Get the length of the instruction sequence
        let instruction_count = instructions.len();
        
        // Print the instruction count for visibility
        println!("Keccak256 inline sequence generated {} instructions", instruction_count);
        ...
        // Assert that we generated a reasonable number of instructions for Keccak256 compression
        // Keccak256 has 24 rounds with multiple operations per round
        assert!(instruction_count > 100, "Expected more than 100 instructions for Keccak256 compression");
        
        println!("Test passed: Generated {} instructions for Keccak256 compression", instruction_count);
    }
}
