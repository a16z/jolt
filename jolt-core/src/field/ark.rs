...
impl JoltField for ark_bn254::Fq {
    const NUM_BYTES: usize = 32;
    const MONTGOMERY_R: Self = ark_ff::Fp::new_unchecked(<ark_bn254::FqConfig as ark_ff::fields::models::fp::MontConfig<4>>::R);
    const MONTGOMERY_R_SQUARE: Self = ark_ff::Fp::new_unchecked(<ark_bn254::FqConfig as ark_ff::fields::models::fp::MontConfig<4>>::R2);
