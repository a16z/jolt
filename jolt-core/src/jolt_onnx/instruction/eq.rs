...
use crate::{
    jolt::{
        instruction::{JoltInstruction, SubtableIndices},
...
mod test {
    ...
    fn beq_instruction_32_e2e() {
        ...
        for _ in 0..256 {
            ...
            let instruction = EQInstruction(x, y);
        ...
        let instructions = vec![
            ...
            EQInstruction(0, 100),
            EQInstruction(1, 0),
            EQInstruction(0, u32_max),
            EQInstruction(u32_max, 0),
            EQInstruction(u32_max, u32_max),
            EQInstruction(u32_max, 1 << 8),
            EQInstruction(1 << 8, u32_max),
        ];
