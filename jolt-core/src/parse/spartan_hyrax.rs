...
fn test_parsing() {
    ...
    let circom_file_path = "./spartan_hyrax.circom";
    let circom_file = "spartan_hyrax";
    // let params: [usize; 4] = [10, 5, 6, 5];
    // let params: [usize; 14] = [10, 23, 24, 23, 4, 54, 26, 4, 4, 4, 11, 4, 16, 22];
    let params: [usize; 4] = [23, 24, 23, 22];
