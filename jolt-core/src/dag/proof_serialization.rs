...
pub struct JoltDagProof<F: JoltField, PCS: CommitmentScheme<Field = F>, FS: Transcript> {
    opening_claims: Claims<F>,
    commitments: Vec<PCS::Commitment>,
    proofs: Proofs<F, PCS, FS>,
}

impl<F: JoltField, PCS: CommitmentScheme<Field = F>, FS: Transcript> JoltDagProof<F, PCS, FS> {
