...
pub struct SRLBitmaskInstruction<const WORD_SIZE: usize>(pub u64);

impl<const WORD_SIZE: usize> JoltInstruction for SRLBitmaskInstruction<WORD_SIZE> {
...
impl<const WORD_SIZE: usize> PrefixSuffixDecomposition<WORD_SIZE>
    for SRLBitmaskInstruction<WORD_SIZE>
{
...
mod test {
    ...
    use super::SRLBitmaskInstruction;
    ...
    fn right_shift_bitmask_materialize_entry() {
        materialize_entry_test::<Fr, SRLBitmaskInstruction<32>>();
    }

    #[test]
    fn right_shift_bitmask_mle_full_hypercube() {
        instruction_mle_full_hypercube_test::<Fr, SRLBitmaskInstruction<8>>();
    }

    #[test]
    fn right_shift_bitmask_mle_random() {
        instruction_mle_random_test::<Fr, SRLBitmaskInstruction<32>>();
    }

    #[test]
    fn right_shift_bitmask_prefix_suffix() {
        prefix_suffix_test::<Fr, SRLBitmaskInstruction<32>>();
    }
}
