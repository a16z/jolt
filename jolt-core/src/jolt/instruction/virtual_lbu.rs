...
pub struct VirtualLBUInstruction<const WORD_SIZE: usize>;

impl<const WORD_SIZE: usize> VirtualInstructionSequence for VirtualLBUInstruction<WORD_SIZE> {
...
mod test {
    ...
    fn lbu_virtual_sequence_32() {
        ...
        for _ in 0..256 {
            ...
            let trace = VirtualLBUInstruction::<32>::virtual_trace(lbu_trace_row);
            assert_eq!(trace.len(), VirtualLBUInstruction::<32>::SEQUENCE_LENGTH);
        }
    }
}
