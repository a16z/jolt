...
impl<const WORD_SIZE: usize> JoltInstruction for VirtualSRAInstruction<WORD_SIZE> {
...
impl<const WORD_SIZE: usize> PrefixSuffixDecomposition<WORD_SIZE>
    for VirtualSRAInstruction<WORD_SIZE>
{
...
mod test {
    ...
    use super::VirtualSRAInstruction;
    ...
    fn virtual_sra_materialize_entry() {
        materialize_entry_test::<Fr, VirtualSRAInstruction<32>>();
    }

    #[test]
    fn virtual_sra_mle_full_hypercube() {
        instruction_mle_full_hypercube_test::<Fr, VirtualSRAInstruction<8>>();
    }

    #[test]
    fn virtual_sra_mle_random() {
        instruction_mle_random_test::<Fr, VirtualSRAInstruction<32>>();
    }

    #[test]
    fn virtual_sra_prefix_suffix() {
        prefix_suffix_test::<Fr, VirtualSRAInstruction<32>>();
    }
}
