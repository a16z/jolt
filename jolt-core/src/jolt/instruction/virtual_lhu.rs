...
pub struct VirtualLHUInstruction<const WORD_SIZE: usize>;

impl<const WORD_SIZE: usize> VirtualInstructionSequence for VirtualLHUInstruction<WORD_SIZE> {
...
mod test {
    ...
    fn lhu_virtual_sequence_32() {
        ...
        for _ in 0..256 {
            ...
            let trace = VirtualLHUInstruction::<32>::virtual_trace(lhu_trace_row);
            assert_eq!(trace.len(), VirtualLHUInstruction::<32>::SEQUENCE_LENGTH);
        }
    }
}
