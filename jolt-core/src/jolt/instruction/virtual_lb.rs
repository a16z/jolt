...
pub struct VirtualLBInstruction<const WORD_SIZE: usize>;

impl<const WORD_SIZE: usize> VirtualInstructionSequence for VirtualLBInstruction<WORD_SIZE> {
...
mod test {
    ...
    fn lb_virtual_sequence_32() {
        ...
        for _ in 0..256 {
            ...
            let trace = VirtualLBInstruction::<32>::virtual_trace(lb_trace_row);
            assert_eq!(trace.len(), VirtualLBInstruction::<32>::SEQUENCE_LENGTH);
        }
    }
}
