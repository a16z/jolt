use crate::jolt::vm::ram::read_write_checking::{
    DataBuffers, RamReadWriteChecking, RamReadWriteCheckingProof, ReadWriteCheckingProverState,
    ReadWriteCheckingVerifierState, ReadWriteSumcheckClaims,
};
use crate::{
