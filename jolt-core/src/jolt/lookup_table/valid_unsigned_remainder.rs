...
mod test {
    ...
    fn assert_valid_unsigned_remainder_materialize_entry() {
        materialize_entry_test::<Fr, ValidUnsignedRemainderTable<32>>();
    }

    #[test]
    fn assert_valid_unsigned_remainder_mle_full_hypercube() {
        instruction_mle_full_hypercube_test::<Fr, ValidUnsignedRemainderTable<8>>();
    }

    #[test]
    fn assert_valid_unsigned_remainder_mle_random() {
        instruction_mle_random_test::<Fr, ValidUnsignedRemainderTable<32>>();
    }
