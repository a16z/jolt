...
mod test {
    ...
    fn assert_valid_signed_remainder_materialize_entry() {
        materialize_entry_test::<Fr, ValidSignedRemainderTable<32>>();
    }

    #[test]
    fn assert_valid_signed_remainder_mle_full_hypercube() {
        instruction_mle_full_hypercube_test::<Fr, ValidSignedRemainderTable<8>>();
    }

    #[test]
    fn assert_valid_signed_remainder_mle_random() {
        instruction_mle_random_test::<Fr, ValidSignedRemainderTable<32>>();
    }
