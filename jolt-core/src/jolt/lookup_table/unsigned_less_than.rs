...
mod test {
    ...
    fn sltu_materialize_entry() {
        materialize_entry_test::<Fr, UnsignedLessThanTable<32>>();
    }
    ...
    fn sltu_mle_full_hypercube() {
        instruction_mle_full_hypercube_test::<Fr, UnsignedLessThanTable<8>>();
    }

    #[test]
    fn sltu_mle_random() {
        instruction_mle_random_test::<Fr, UnsignedLessThanTable<32>>();
    }
}
