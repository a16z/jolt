...
use crate::{
    ...
    zkvm::{
        ...
        instruction_lookups::{
            self, claim_reduction::InstructionClaimReductionSumcheckProver,
            ra_virtual::RaSumcheckProver as LookupsRaSumcheckProver,
    ...
    JoltCpuProver<'a, F, PCS, ProofTranscript>
{
    ...
    fn prove_stage2(
        ...
        let instruction_claim_reduction = InstructionClaimReductionSumcheckProver::gen(
            Arc::clone(&self.trace),
            &self.opening_accumulator,
            &mut self.transcript,
        );
        ...
        #[cfg(feature = "allocative")]
        {
            ...
            print_data_structure_heap_usage(
                "InstructionClaimReductionSumcheckProver",
