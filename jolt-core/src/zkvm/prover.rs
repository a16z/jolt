    ...
    > JoltCpuProver<'a, F, C, PCS, ProofTranscript>
{
    ...
    pub fn benchmark_stage2_ms(mut self) -> f64 {
        ...
        let start = Instant::now();
        let _stage2 = self.prove_stage2();
        start.elapsed().as_secs_f64() * 1000.0
    }

    #[doc(hidden)]
    #[cfg(not(target_arch = "wasm32"))]
    pub fn benchmark_stage3_ms(mut self) -> f64 {
        let preprocessing_digest = self.preprocessing.shared.digest();
        fiat_shamir_preamble(
            &self.program_io,
            self.one_hot_params.ram_k,
        ...
        let start = Instant::now();
        let _stage3 = self.prove_stage3();
        start.elapsed().as_secs_f64() * 1000.0
    }

    #[doc(hidden)]
    #[cfg(not(target_arch = "wasm32"))]
    pub fn benchmark_stage4_ms(mut self) -> f64 {
        let preprocessing_digest = self.preprocessing.shared.digest();
        fiat_shamir_preamble(
            &self.program_io,
            self.one_hot_params.ram_k,
        ...
        let start = Instant::now();
        let _stage4 = self.prove_stage4();
        start.elapsed().as_secs_f64() * 1000.0
    }

    #[doc(hidden)]
    #[cfg(not(target_arch = "wasm32"))]
    pub fn benchmark_stage5_ms(mut self) -> f64 {
        let preprocessing_digest = self.preprocessing.shared.digest();
        fiat_shamir_preamble(
            &self.program_io,
            self.one_hot_params.ram_k,
        ...
        let start = Instant::now();
        let _stage5 = self.prove_stage5();
        start.elapsed().as_secs_f64() * 1000.0
    }

    #[doc(hidden)]
    #[cfg(not(target_arch = "wasm32"))]
    pub fn benchmark_stage6_ms(mut self) -> f64 {
        let preprocessing_digest = self.preprocessing.shared.digest();
        fiat_shamir_preamble(
            &self.program_io,
            self.one_hot_params.ram_k,
        ...
        let start = Instant::now();
        let _stage6 = self.prove_stage6();
        start.elapsed().as_secs_f64() * 1000.0
    }

    #[doc(hidden)]
    #[cfg(not(target_arch = "wasm32"))]
    pub fn benchmark_stage7_ms(mut self) -> f64 {
        let preprocessing_digest = self.preprocessing.shared.digest();
        fiat_shamir_preamble(
            &self.program_io,
            self.one_hot_params.ram_k,
        ...
        let start = Instant::now();
        let _stage7 = self.prove_stage7();
        start.elapsed().as_secs_f64() * 1000.0
    }

    #[doc(hidden)]
    #[cfg(not(target_arch = "wasm32"))]
    pub fn benchmark_stage8_ms(mut self) -> f64 {
        let preprocessing_digest = self.preprocessing.shared.digest();
        fiat_shamir_preamble(
            &self.program_io,
            self.one_hot_params.ram_k,
        ...
        let start = Instant::now();
        let _stage8 = self.prove_stage8(opening_proof_hints);
        start.elapsed().as_secs_f64() * 1000.0
    }
