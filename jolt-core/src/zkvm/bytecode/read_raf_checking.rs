...
impl<F: JoltField> SumcheckInstanceParams<F> for BytecodeReadRafSumcheckParams<F> {
    ...
    fn input_claim_constraint(&self) -> InputClaimConstraint {
        ...
        // - Stage 2 (SpartanProductVirtualization + InstructionInputVirtualization): 11 terms
        // - Stage 3 (SpartanShift): 4 terms
        ...
        // Stage 2: SpartanProductVirtualization + InstructionInputVirtualization openings
        // Order: Jump, Branch, IsRdNotZero, WriteLookupOutputToRD, VirtualInstruction,
        //        Imm, UnexpandedPC, LeftIsRs1, LeftIsPC, RightIsRs2, RightIsImm
        terms.push(ProductTerm::scaled(
            ValueSource::Challenge(challenge_idx),
            vec![ValueSource::Opening(OpeningId::virt(
                VirtualPolynomial::OpFlags(CircuitFlags::Jump),
        ...
        // Stage 3: SpartanShift openings
        // Order: UnexpandedPC, IsNoop, VirtualInstruction, IsFirstInSequence
        terms.push(ProductTerm::scaled(
            ValueSource::Challenge(challenge_idx),
            vec![ValueSource::Opening(OpeningId::virt(
                VirtualPolynomial::UnexpandedPC,
