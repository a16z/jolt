...
pub fn verify_stage1_uni_skip<F: JoltField, C: JoltCurve<F = F>, T: Transcript, A: OpeningAccumulator<F>>(
...
pub fn verify_stage2_uni_skip<F: JoltField, C: JoltCurve<F = F>, T: Transcript, A: OpeningAccumulator<F>>(
    proof: &UniSkipFirstRoundProofVariant<F, C, T>,
    opening_accumulator: &mut A,
    transcript: &mut T,
