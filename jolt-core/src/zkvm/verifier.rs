...
use crate::poly::commitment::commitment_scheme::{CommitmentScheme, CompressedCommitmentScheme};
use crate::subprotocols::sumcheck::BatchedSumcheck;
use crate::zkvm::config::OneHotParams;
use crate::zkvm::proof_serialization::JoltCompressedProof;
use crate::zkvm::{
    bytecode::{
...
pub struct JoltCompressedVerifier<
    'a,
    F: JoltField,
    PCS: CompressedCommitmentScheme<Field = F>,
    ProofTranscript: Transcript,
> {
    pub trusted_advice_commitment: Option<PCS::CompressedCommitment>,
    pub program_io: JoltDevice,
    pub proof: JoltCompressedProof<F, PCS, ProofTranscript>,
    pub preprocessing: &'a JoltVerifierPreprocessing<F, PCS>,
    pub transcript: ProofTranscript,
    pub opening_accumulator: VerifierOpeningAccumulator<F>,
    pub spartan_key: UniformSpartanKey<F>,
...
impl<'a, F: JoltField, PCS: CompressedCommitmentScheme<Field = F>, ProofTranscript: Transcript>
    JoltCompressedVerifier<'a, F, PCS, ProofTranscript>
{
    pub fn new(
        preprocessing: &'a JoltVerifierPreprocessing<F, PCS>,
        proof: JoltCompressedProof<F, PCS, ProofTranscript>,
        mut program_io: JoltDevice,
        trusted_advice_commitment: Option<PCS::CompressedCommitment>,
        _debug_info: Option<ProverDebugInfo<F, ProofTranscript, PCS>>,
    ) -> Result<Self, ProofVerifyError> {
        // Memory layout checks
        if program_io.memory_layout != preprocessing.memory_layout {
