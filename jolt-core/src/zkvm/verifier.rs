    ...
    C::G1: From<crate::curve::Bn254G1>,
{
    ...
    pub fn verify(mut self) -> Result<(), ProofVerifyError> {
        ...
        if zk_mode {
            #[cfg(feature = "zk")]
            {
                ...
                let output_constraint_challenge_values: [Vec<F>; 6] = [
    ...
    fn verify_blindfold(
        ...
        stage_output_constraints: &[Option<OutputClaimConstraint>; 6],
        output_constraint_challenge_values: &[Vec<F>; 6],
        stage_input_constraints: &[InputClaimConstraint; 6],
        input_constraint_challenge_values: &[Vec<F>; 6],
        ...
        stage7_data: &Stage8VerifyData<F>,
        ...
        let extra_constraint_terms: Vec<(ValueSource, ValueSource)> = stage7_data
            .opening_ids
            .iter()
            .enumerate()
        ...
        let all_input_challenge_values: [&[F]; 8] = [
        ...
        let baked = BakedPublicInputs {
            ...
            extra_constraint_challenges: stage7_data.constraint_coeffs.clone(),
        };
    ...
    fn verify_stage7(&mut self) -> Result<Stage8VerifyData<F>, ProofVerifyError> {
        ...
        let lagrange_factor: F = EqPolynomial::zero_selector(r_address_stage6);
