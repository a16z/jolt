...
> {
    ...
    pub untrusted_advice_commitment: Option<PCS::CompressedCommitment>,
    pub trace_length: usize,
    pub ram_K: usize,
    pub bytecode_K: usize,
    pub log_k_chunk: usize,
...
// TODO: need to better factor this (perhaps using a macro) as this is identical to the uncompressed proof serialization
impl<F: JoltField, PCS: CompressedCommitmentScheme<Field = F>, FS: Transcript> CanonicalSerialize
    for JoltCompressedProof<F, PCS, FS>
{
...
// TODO: need to better factor this (perhaps using a macro) as this is identical to the uncompressed proof validation
impl<F: JoltField, PCS: CompressedCommitmentScheme<Field = F>, FS: Transcript> Valid
    for JoltCompressedProof<F, PCS, FS>
{
...
// TODO: need to better factor this (perhaps using a macro) as this is identical to the uncompressed proof deserialization
impl<F: JoltField, PCS: CompressedCommitmentScheme<Field = F>, FS: Transcript> CanonicalDeserialize
    for JoltCompressedProof<F, PCS, FS>
{
...
impl<F: JoltField, PCS: CommitmentScheme<Field = F>, FS: Transcript> CanonicalSerialize
    for JoltUncompressedProof<F, PCS, FS>
{
    fn serialize_with_mode<W: Write>(
        &self,
        mut writer: W,
