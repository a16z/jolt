...
impl R1CSCycleInputs {
        ...
        F: JoltField,
    {
        ...
        let virtual_sequence_active = flags_view[CircuitFlags::VirtualInstruction] && !next_is_noop;
    ...
    impl JoltR1CSInputs {
        ...
        const fn const_eq(&self, other: &JoltR1CSInputs) -> bool {
            match (self, other) {
                ...
                (JoltR1CSInputs::VirtualSequenceActive, JoltR1CSInputs::VirtualSequenceActive) => {
                    true
                }
