...
///
/// ```text
/// sum_j eq(r_cycle, j) * (VirtualRa0(j) + gamma * VirtualRa1(j) + gamma^2 * VirtualRa2(j) + gamma^3 * VirtualRa3(j))
/// ```
///
/// Where
///
/// ```text
/// VirtualRa0(x) = CommittedRa00(x) * CommittedRa01(x) * CommittedRa02(x) * CommittedRa03(x)
/// VirtualRa1(x) = CommittedRa04(x) * CommittedRa05(x) * CommittedRa06(x) * CommittedRa07(x)
/// VirtualRa2(x) = CommittedRa08(x) * CommittedRa09(x) * CommittedRa10(x) * CommittedRa11(x)
/// VirtualRa3(x) = CommittedRa12(x) * CommittedRa13(x) * CommittedRa14(x) * CommittedRa15(x)
/// ```
