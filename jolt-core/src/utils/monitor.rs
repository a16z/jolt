    ...
    pub fn start(interval_secs: f64) -> Self {
        ...
        let handle = thread::spawn(move || {
            ...
            while !stop_flag_clone.load(Ordering::Relaxed) {
                ...
                // Report number of cores with CPU usage > 10%
                ...
                tracing::debug!(
                    ...
                    metrics.cores_active_avg = cores_active_avg,
                    metrics.cores_active = active_cores_5per,
                    metrics.thread_count = active_threads,
                );
