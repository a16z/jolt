...
pub fn trace(
    ...
    // Drain FieldReg events emitted by any FieldOp / FieldMov / FieldSLL* cycles
...
impl CheckpointingTracer {
    ...
    /// Take ownership of the FieldReg event stream from the emulator. Events
    /// are cycle-indexed `FieldRegEvent` records emitted by FieldOp / FieldMov
    /// / FieldSLL* instructions during trace.
