use common::constants::{
    RISCV_REGISTER_COUNT, VIRTUAL_INSTRUCTION_MAX_REGISTER_COUNT, VIRTUAL_REGISTER_COUNT,
};
use core::cell::RefCell;
use std::ops::Deref;

const NUM_VIRTUAL_REGISTERS: usize = VIRTUAL_REGISTER_COUNT as usize;
const NUM_VIRTUAL_INSTRUCTION_REGISTERS: usize = VIRTUAL_INSTRUCTION_MAX_REGISTER_COUNT as usize;
