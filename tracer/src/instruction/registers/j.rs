use crate::{
    emulator::cpu::Cpu,
    instruction::{format::format_j::FormatJ, RISCVInstruction},
};
...
pub struct RegisterStateJ {
    pub rd: (u64, u64), // (old_value, new_value)
}

impl InstructionRegisterState for RegisterStateJ {
    #[cfg(any(feature = "test-utils", test))]
...
impl<I> RegisterSnapshot<I> for RegisterStateJ
where
    I: RISCVInstruction<Format = FormatJ>,
{
    type Before = u64;
