...
impl VirtualSha256Compression {
    fn exec(
        &self,
        cpu: &mut Cpu,
        _ram_access: &mut <VirtualSha256Compression as RISCVInstruction>::RAMAccess,
    ) {
...
impl RISCVTrace for VirtualSha256Compression {
...
impl VirtualInstructionSequence for VirtualSha256Compression {
