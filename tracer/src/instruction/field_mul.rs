//! BN254 Fr FieldMul: `field_regs[frd] = field_regs[frs1] · field_regs[frs2]`.
//!
//! Encoded as opcode `0x0B` (custom-0) + funct7 `0x40` + funct3 `0x02`.
...
declare_riscv_instr!(
    ...
    match  = field_arith_match(FUNCT3_FMUL),
    format = FormatR,
    ram    = ()
);
