//! FieldSLL192 (funct3 = 0x0A) — integer→field shift-left-192 on-ramp.
//!
//! Writes `FReg[frd] = (XReg[rs1] as Fr) · 2¹⁹²`, which in natural-form limbs
//! places the integer in limb 3:
//!
...
pub const FUNCT3_FIELD_SLL192: u8 = 0x02;

#[derive(Debug, Clone, Copy, Default, Serialize, Deserialize, PartialEq)]
pub struct FieldSLL192 {
    pub address: u64,
...
impl RISCVInstruction for FieldSLL192 {
    const MASK: u32 = 0xfe00_707f;
    const MATCH: u32 =
        (BN254_FR_SLL_FUNCT7 << 25) | ((FUNCT3_FIELD_SLL192 as u32) << 12) | FIELD_OP_OPCODE;
...
impl RISCVTrace for FieldSLL192 {
...
impl From<NormalizedInstruction> for FieldSLL192 {
...
impl From<FieldSLL192> for NormalizedInstruction {
    fn from(instr: FieldSLL192) -> NormalizedInstruction {
        NormalizedInstruction {
            instruction_kind: JoltInstructionKind::FieldSLL192,
...
mod tests {
    ...
    #[test]
    fn field_sll192_lands_in_limb_three() {
        let mut cpu = test_cpu();
        cpu.x[5] = 0xabcd_ef01_2345_6789_u64 as i64;
        let word = encode_r(
            FIELD_OP_OPCODE,
            FUNCT3_FIELD_SLL192 as u32,
            BN254_FR_SLL_FUNCT7,
            3,
            5,
            0,
        );
        let op = FieldSLL192::new(word, 0x1000, true, false);
        op.execute(&mut cpu, &mut ());
        assert_eq!(cpu.field_regs[3], [0, 0, 0, 0xabcd_ef01_2345_6789]);
    }
}
