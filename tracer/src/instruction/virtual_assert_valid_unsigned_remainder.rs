...
pub struct VirtualAssertValidUnsignedRemainder<const WORD_SIZE: usize> {
    pub address: u64,
...
impl<const WORD_SIZE: usize> RISCVInstruction for VirtualAssertValidUnsignedRemainder<WORD_SIZE> {
