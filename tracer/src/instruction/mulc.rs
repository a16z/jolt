...
impl RISCVInstruction for MULC {
    const MASK: u32 = 0xfe00_707f;
    const MATCH: u32 = 0x0e00_005b;
    ...
    fn source_kind(&self) -> jolt_riscv::SourceInstructionKind {
        jolt_riscv::SourceInstructionKind::Mulc(jolt_riscv::instructions::Mulc(()))
    }
    ...
    fn execute(&self, cpu: &mut Cpu, _: &mut Self::RAMAccess) {
        let product = (cpu.x[self.operands.rs1 as usize] as u64 as u128)
            ...
            .wrapping_add(self.prev_aux as u128);
        cpu.write_register(
...
impl From<super::SourceInstructionRow> for MULC {
