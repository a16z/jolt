//! BN254 Fr FieldSub: `field_regs[frd] = field_regs[frs1] − field_regs[frs2]`.
//!
//! Encoded as opcode `0x0B` + funct7 `0x40` + funct3 `0x05`.
...
declare_riscv_instr!(
    ...
    match  = field_arith_match(FUNCT3_FSUB),
    format = FormatR,
    ram    = ()
);

impl FieldSub {
    fn exec(&self, cpu: &mut Cpu, _: &mut <FieldSub as crate::instruction::RISCVInstruction>::RAMAccess) {
