...
In Jolt, most sumcheck data structures implement the `Allocative` trait, and we generate a flamegraph at the start and end of stages 2-7 (see `crates/jolt-prover/src/zkvm/prover.rs`).
