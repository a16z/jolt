...
The Jolt implementation of Dory lives in `crates/jolt-prover/src/poly/commitment/dory/` and wraps the [`a16z/dory`](https://github.com/a16z/dory/) library. Key files:
