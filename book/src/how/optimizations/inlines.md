...
| KECCAK256     | 0x0B   | 0x01   | 0x00   | Deprecated: Keccak-256 permutation with no block operand. Kept so legacy guest sequences still decode; the SDK never emits it, new code must not either |
