...
Other moduli use the portable Rust implementation. `Prime64Offset59` also uses
portable Rust because an inline assembly experiment made several measured
operations slower. Its proof objects are inspection artifacts and are not
called by normal production dispatch.
