...
The claim reduction sumchecks can be found in `jolt-prover/src/zkvm/claim_reductions/` and include:
...
The implementation is located in `compute_final_opening_point()` in `jolt-prover/src/zkvm/mod.rs`.
