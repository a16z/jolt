...
let JOLT_FP128_SUB_X86_64_CORRECT = time prove
 (`!a0 a1 b0 b1 pc.
  ...
  X86_ACCSTEPS_TAC JOLT_FP128_SUB_X86_64_EXEC [1;2;5;6] (1--6) THEN
  ...
  SUBGOAL_THEN
   `2 EXP 128 * bitval carry_s6 + d =
    val(if carry_s2 then word 4294944759 else (word 0:int64)) + t`
  ASSUME_TAC THENL
