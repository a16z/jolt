...
SOURCE_PATHS = (
    "crates/jolt-kernels/src/metal/backend.rs",
    ...
    "crates/jolt-kernels/src/metal/solinas/address_sequence/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/address_raf/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/address_raf_direct/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/address_suffix/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/address_suffix_full/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/booleanity/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/booleanity_address/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/booleanity_common.metal",
    "crates/jolt-kernels/src/metal/solinas/bytecode_cycle/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/bytecode_row/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/deferred_sum.metal",
    "crates/jolt-kernels/src/metal/solinas/fp128.metal",
    "crates/jolt-kernels/src/metal/solinas/instruction_input/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/instruction_ra_common.metal",
    "crates/jolt-kernels/src/metal/solinas/instruction_ra_sequence/shader.metal",
    "crates/jolt-kernels/src/metal/solinas/instruction_ra_virtualization/shader.metal",
    ...
    "crates/jolt-kernels/src/metal/solinas/outer_remainder/shader.rs",
    "crates/jolt-kernels/src/metal/solinas/outer_remainder/storage.rs",
    "crates/jolt-kernels/src/metal/solinas/outer_remainder/tests.rs",
    "crates/jolt-kernels/src/metal/solinas/probes.metal",
    "crates/jolt-kernels/src/metal/solinas/product5/shader.metal",
    ...
    "crates/jolt-kernels/src/metal/solinas/spartan_outer_uniskip/shader.metal",
