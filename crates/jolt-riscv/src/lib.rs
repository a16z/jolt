    ...
    ($callback:ident) => {
        $callback! {
            instructions: [
                ...
                VirtualShiftRightBitmaskW => VirtualShiftRightBitmaskW => (0x008f, "jolt.virtual.shift_right_bitmask_w"),
                VirtualSRLW => VirtualSrlw => (0x0090, "jolt.virtual.srlw"),
                VirtualSRLIW => VirtualSrliw => (0x0091, "jolt.virtual.srliw"),
                VirtualSRAW => VirtualSraw => (0x0092, "jolt.virtual.sraw"),
                VirtualSRAIW => VirtualSraiw => (0x0093, "jolt.virtual.sraiw"),
                #[cfg(feature = "field-inline")]
