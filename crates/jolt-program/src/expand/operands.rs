...
pub(super) fn noop_for(instruction: SourceRow) -> JoltRow {
...
pub(super) fn rd(instruction: &SourceRow) -> Result<u8, ExpansionError> {
    instruction
        .operands
        .rd
...
pub(super) fn rs1(instruction: &SourceRow) -> Result<u8, ExpansionError> {
    instruction
        .operands
        .rs1
...
pub(super) fn rs2(instruction: &SourceRow) -> Result<u8, ExpansionError> {
    instruction
        .operands
        .rs2
...
pub(super) fn csr_address(instruction: &SourceRow) -> u16 {
