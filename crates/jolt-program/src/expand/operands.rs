...
pub(super) fn noop_for(instruction: JoltRow) -> JoltRow {
...
pub(super) fn rd(instruction: &JoltRow) -> Result<u8, ExpansionError> {
    instruction
        .operands
        .rd
...
pub(super) fn rs1(instruction: &JoltRow) -> Result<u8, ExpansionError> {
    instruction
        .operands
        .rs1
...
pub(super) fn rs2(instruction: &JoltRow) -> Result<u8, ExpansionError> {
    instruction
        .operands
        .rs2
...
pub(super) fn csr_address(instruction: &JoltRow) -> u16 {
