#![no_main]
use jolt_field::{Accumulator, Fr, CanonicalEncoding, WideAccumulator};
...
fuzz_target!(|data: &[u8]| {
    ...
    for i in 0..pairs {
        let offset = i * 64;
        let a = <Fr as CanonicalEncoding>::from_bytes_le_reduced(&data[offset..offset + 32]);
        let b =
            <Fr as CanonicalEncoding>::from_bytes_le_reduced(&data[offset + 32..offset + 64]);
