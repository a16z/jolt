...
use jolt_field::{
    FpExt4, Ring, Field, Prime128Offset275, Prime31Offset19, CanonicalEncoding,
};
...
fuzz_target!(|data: &[u8]| {
    ...
    let a31 = Prime31Offset19::from_bytes_le_reduced(&data[..16]);
    let b31 = Prime31Offset19::from_bytes_le_reduced(&data[16..32]);
    ...
    let a128 = Prime128Offset275::from_bytes_le_reduced(&data[..32]);
    let b128 = Prime128Offset275::from_bytes_le_reduced(&data[32..64]);
