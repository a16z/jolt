...
mod test {
    ...
    /// One `prefix_suffix`, 8-bit exhaustive hypercube, and `mle_random` test
    /// per Keccak rho-fusion rotation amount.
    macro_rules! keccak_xor_rot_tests {
        ($($n:literal => ($ps:ident, $cube:ident, $random:ident)),+ $(,)?) => {
            $(
                #[test]
                fn $ps() {
                ...
                #[test]
                fn $cube() {
                    lookup_table_mle_full_hypercube_test::<Fr, VirtualXORROTTable<8, $n>>();
                }
    ...
    keccak_xor_rot_tests!(
        2 => (prefix_suffix_2, mle_full_hypercube_2, mle_random_2),
        3 => (prefix_suffix_3, mle_full_hypercube_3, mle_random_3),
        8 => (prefix_suffix_8, mle_full_hypercube_8, mle_random_8),
        9 => (prefix_suffix_9, mle_full_hypercube_9, mle_random_9),
        19 => (prefix_suffix_19, mle_full_hypercube_19, mle_random_19),
        20 => (prefix_suffix_20, mle_full_hypercube_20, mle_random_20),
        21 => (prefix_suffix_21, mle_full_hypercube_21, mle_random_21),
        23 => (prefix_suffix_23, mle_full_hypercube_23, mle_random_23),
        25 => (prefix_suffix_25, mle_full_hypercube_25, mle_random_25),
        28 => (prefix_suffix_28, mle_full_hypercube_28, mle_random_28),
        36 => (prefix_suffix_36, mle_full_hypercube_36, mle_random_36),
        37 => (prefix_suffix_37, mle_full_hypercube_37, mle_random_37),
        39 => (prefix_suffix_39, mle_full_hypercube_39, mle_random_39),
        43 => (prefix_suffix_43, mle_full_hypercube_43, mle_random_43),
        44 => (prefix_suffix_44, mle_full_hypercube_44, mle_random_44),
        46 => (prefix_suffix_46, mle_full_hypercube_46, mle_random_46),
        49 => (prefix_suffix_49, mle_full_hypercube_49, mle_random_49),
        50 => (prefix_suffix_50, mle_full_hypercube_50, mle_random_50),
        54 => (prefix_suffix_54, mle_full_hypercube_54, mle_random_54),
        56 => (prefix_suffix_56, mle_full_hypercube_56, mle_random_56),
        58 => (prefix_suffix_58, mle_full_hypercube_58, mle_random_58),
        61 => (prefix_suffix_61, mle_full_hypercube_61, mle_random_61),
        62 => (prefix_suffix_62, mle_full_hypercube_62, mle_random_62),
    );
