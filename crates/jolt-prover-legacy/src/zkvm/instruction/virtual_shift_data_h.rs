...
use tracer::instruction::{virtual_shift_data_h::VirtualShiftDataH, RISCVCycle};

use crate::zkvm::lookup_table::{shift_data_h::ShiftDataHTable, LookupTables};

use super::{CircuitFlags, Flags, InstructionLookup, LookupQuery, NUM_CIRCUIT_FLAGS};

impl<const XLEN: usize> InstructionLookup<XLEN> for VirtualShiftDataH {
    fn lookup_table(&self) -> Option<LookupTables<XLEN>> {
        Some(ShiftDataHTable.into())
    }
}

impl Flags for VirtualShiftDataH {
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<VirtualShiftDataH> {
...
mod test {
    ...
    fn materialize_entry() {
        materialize_entry_test::<Fr, VirtualShiftDataH>();
    }

    #[test]
    fn lookup_output_matches_trace() {
        lookup_output_matches_trace_test::<VirtualShiftDataH>();
    }
}
