...
use tracer::instruction::{virtual_shift_data_w::VirtualShiftDataW, RISCVCycle};

use crate::zkvm::lookup_table::{shift_data_w::ShiftDataWTable, LookupTables};

use super::{CircuitFlags, Flags, InstructionLookup, LookupQuery, NUM_CIRCUIT_FLAGS};

impl<const XLEN: usize> InstructionLookup<XLEN> for VirtualShiftDataW {
    fn lookup_table(&self) -> Option<LookupTables<XLEN>> {
        Some(ShiftDataWTable.into())
    }
}

impl Flags for VirtualShiftDataW {
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<VirtualShiftDataW> {
...
mod test {
    ...
    fn materialize_entry() {
        materialize_entry_test::<Fr, VirtualShiftDataW>();
    }

    #[test]
    fn lookup_output_matches_trace() {
        lookup_output_matches_trace_test::<VirtualShiftDataW>();
    }
}
