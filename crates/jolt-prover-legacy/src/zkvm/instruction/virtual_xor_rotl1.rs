use tracer::instruction::{virtual_xor_rotl1::VirtualXORROTL1, RISCVCycle};

use crate::zkvm::instruction::{InstructionFlags, NUM_INSTRUCTION_FLAGS};
use crate::zkvm::lookup_table::{virtual_xor_rotl1::VirtualXORROTL1Table, LookupTables};

use super::{CircuitFlags, Flags, InstructionLookup, LookupQuery, NUM_CIRCUIT_FLAGS};

impl<const XLEN: usize> InstructionLookup<XLEN> for VirtualXORROTL1 {
    fn lookup_table(&self) -> Option<LookupTables<XLEN>> {
        Some(VirtualXORROTL1Table::<XLEN>.into())
    }
}

impl Flags for VirtualXORROTL1 {
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<VirtualXORROTL1> {
...
mod tests {
    ...
    fn materialize_entry() {
        materialize_entry_test::<Fr, VirtualXORROTL1>();
    }

    #[test]
    fn lookup_output_matches_trace() {
        lookup_output_matches_trace_test::<VirtualXORROTL1>();
    }
}
