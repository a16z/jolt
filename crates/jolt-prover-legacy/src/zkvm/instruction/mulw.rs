use tracer::instruction::{mulw::MULW, RISCVCycle};
...
impl<const XLEN: usize> InstructionLookup<XLEN> for MULW {
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<MULW> {
...
mod tests {
    ...
    fn materialize_entry() {
        materialize_entry_test::<Fr, MULW>();
    }

    #[test]
    fn lookup_output_matches_trace() {
        lookup_output_matches_trace_test::<MULW>();
    }
}
