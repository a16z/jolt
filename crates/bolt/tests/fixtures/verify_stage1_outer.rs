...
pub const STAGE1_SUMCHECK_EVALS: &[Stage1SumcheckEvalPlan] = &[
    ...
    Stage1SumcheckEvalPlan { symbol: "stage1.outer_remaining.eval.FieldRdWriteValue", source: "stage1.outer_remaining.sumcheck", name: "stage1.outer_remaining.eval.FieldRdWriteValue", index: 46, oracle: "FieldRdWriteValue" },
];
