...
use super::super::super::super::support::{
    classify_compute_pcs_op, PcsDialect, PcsLoweringRole, PcsOpFamily,
    COMPUTE_OPENING_BATCH_OPENING_RESULT_TYPES, COMPUTE_OPENING_BATCH_RESULT_TYPES,
    COMPUTE_OPENING_CLAIM_RESULT_TYPES,
};

pub(super) struct KernelResolutionPcsDialect;

impl PcsDialect for KernelResolutionPcsDialect {
    type Phase = Compute;
