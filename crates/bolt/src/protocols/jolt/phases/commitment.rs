...
use crate::schema::{
    int_attr, operation_name, symbol_array_attr, symbol_attr, verify_compute_schema, SchemaError,
};
...
use super::lowering::string_attr;
...
pub fn lower_compute_to_cpu<'c>(
    ...
    crate::pass::lower_compute_to_cpu(context, module)
}
