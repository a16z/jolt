//! R1CS key derived from an R1CS instance.
//!
...
/// Precomputed R1CS key containing MLEs of the constraint matrices.
///
...
impl<F: Field> R1csKey<F> {
    /// Builds an [`R1csKey`] from an R1CS instance.
    ///
    ...
    #[tracing::instrument(skip_all, name = "R1csKey::from_r1cs")]
...
mod tests {
    ...
    fn key_dimensions_match_r1cs() {
        ...
        let key = R1csKey::from_r1cs(&r1cs);
