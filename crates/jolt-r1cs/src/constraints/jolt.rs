...
use super::field_constraints::{
    ...
    ROW_LOAD_ACCUMULATE_FROM_REGISTER, ROW_LOAD_IMM, ROW_STORE_TO_REGISTER,
    ROW_STORE_TO_REGISTER_LOOKUP, V_CONST, V_FIELD_INV_PRODUCT, V_FIELD_PRODUCT, V_FIELD_RD_VALUE,
    V_FIELD_RS1_VALUE, V_FIELD_RS2_VALUE, V_IMM, V_IS_FIELD_ADD, V_IS_FIELD_ADVICE_LIMB,
    V_IS_FIELD_ASSERT_EQ, V_IS_FIELD_INV, V_IS_FIELD_LOAD_ACCUMULATE_FROM_MEMORY,
    V_IS_FIELD_LOAD_ACCUMULATE_FROM_REGISTER, V_IS_FIELD_LOAD_IMM, V_IS_FIELD_MUL,
    V_IS_FIELD_STORE_TO_REGISTER, V_IS_FIELD_SUB, V_X_RD_WRITE_VALUE, V_X_RIGHT_LOOKUP_OPERAND,
    V_X_RS1_VALUE,
};
...
pub const SPARTAN_OUTER_SECOND_GROUP_ROWS: [usize; SPARTAN_OUTER_SECOND_GROUP_ROW_COUNT] = [
    ...
    RV64_NUM_EQ_CONSTRAINTS + ROW_STORE_TO_REGISTER,
    RV64_NUM_EQ_CONSTRAINTS + ROW_LOAD_IMM,
    FIELD_INLINE_ROW_BASE + ROW_STORE_TO_REGISTER_LOOKUP,
...
pub const fn field_inline_column(local_column: usize) -> Option<usize> {
    match local_column {
        ...
        V_IS_FIELD_STORE_TO_REGISTER => Some(FIELD_INLINE_COLUMN_BASE + 11),
