...
struct FieldRegistersIncClaimReductionKernel<F: Field> {
...
impl<F: Field> allocative::Allocative for FieldRegistersIncClaimReductionKernel<F> {
...
impl<F: Field> FieldRegistersIncClaimReductionKernel<F> {
...
impl<F: Field> ProveRounds<F> for FieldRegistersIncClaimReductionKernel<F> {
...
impl<F: Field> SumcheckKernel<F> for FieldRegistersIncClaimReductionKernel<F> {
