...
pub(crate) fn prepare_bytecode_read_raf_address<F: Field>(
    session: &mut ProofSession,
    witness: &dyn JoltWitnessPlane<F>,
    inputs: ProverInputs<'_, F, BytecodeReadRafAddressPhase<F>>,
...
pub(crate) struct AddressKernel<F: Field> {
    rounds: usize,
...
#[cfg(feature = "akita")]
pub(crate) enum LazyFusedInc<F: Field> {
    Lazy {
...
pub(crate) struct BytecodePcChunks {
    #[cfg(not(feature = "akita"))]
    rows: Arc<Vec<PcRow>>,
    #[cfg(feature = "akita")]
    rows: Arc<Vec<InstructionCycleRow>>,
...
pub(crate) struct CycleKernel<F: Field> {
    ...
    #[cfg(feature = "akita")]
    pub(crate) algebra: BytecodeCycleAlgebra,
    pub(crate) tables: CycleTableState<F>,
...
pub(crate) struct CycleCpuTables<F: Field> {
    pub(crate) ra: LazyFoldedRa<F, BytecodePcChunks>,
    pub(crate) combined: Polynomial<F>,
    #[cfg(feature = "akita")]
    pub(crate) fused_inc: LazyFusedInc<F>,
    #[cfg(feature = "akita")]
    pub(crate) fused_combined: Polynomial<F>,
}

pub(crate) enum CycleTableState<F: Field> {
...
#[cfg(all(feature = "akita", feature = "metal", target_os = "macos"))]
pub(crate) fn bytecode_cycle_state_error<F: Field>(message: impl Into<String>) -> SumcheckError<F> {
