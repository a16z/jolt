...
impl KernelId {
    pub const ALL: [Self; 92] = [
        ...
        Self::IrrPhaseScan,
        Self::IrrPhaseScanFixed,
        Self::IrrPhaseScanScatter,
        Self::IrrPhaseScanEager,
        Self::IrrPhaseScanLegacy,
        Self::IrrSuffixScan,
        Self::IrrSuffixScanFixed,
        Self::IrrSuffixScanGrouped,
        Self::IrrSuffixScanEager,
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::IrrPhaseScanFixed => "jk_irr_phase_scan_fixed",
            Self::IrrPhaseScanScatter => "jk_irr_phase_scan_scatter",
            Self::IrrPhaseScanEager => "jk_irr_phase_scan_eager",
            Self::IrrPhaseScanLegacy => "jk_irr_phase_scan_legacy",
            Self::IrrSuffixScan => "jk_irr_suffix_scan",
            Self::IrrSuffixScanFixed => "jk_irr_suffix_scan_fixed",
            Self::IrrSuffixScanGrouped => "jk_irr_suffix_scan_grouped",
            Self::IrrSuffixScanEager => "jk_irr_suffix_scan_eager",
