//! The ordinary-profile end-to-end acceptance matrix: guests × protocol modes.
//!
...
//! `akita_e2e.rs`. Field-inline profiles have dedicated coverage in
//! `field_inline_e2e.rs` and `akita_field_inline_e2e.rs`.

#[cfg(all(feature = "prover-fixtures", not(feature = "field-inline")))]
mod support;
