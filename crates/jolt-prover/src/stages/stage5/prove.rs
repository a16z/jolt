    ...
    VC: VectorCommitment<Field = F>,
{
    ...
    let verifier_output = Stage5ClearOutput {
        ...
        batch: VerifiedStage5Batch {
            ...
            field_registers_val_evaluation: VerifiedStage5Sumcheck {
                input_claim: prefix.input_claims.field_registers_val_evaluation,
                sumcheck_point: output.field_registers_val_evaluation_sumcheck_point,
                opening_point: output.field_registers_val_evaluation_opening_point,
                expected_output_claim: output.expected_outputs.field_registers_val_evaluation,
            },
        },
    };
    Ok(Stage5CommittedProofComponent {
