...
pub const STAGE5_KERNELS: &[Stage5KernelPlan] = &[
    ...
    Stage5KernelPlan { symbol: "jolt.cpu.stage5.field_registers_val_evaluation", relation: "jolt.stage5.field_registers_val_evaluation", kind: "sumcheck", backend: "cpu", abi: "jolt_stage5_field_registers_val_evaluation" },
...
pub const STAGE5_SUMCHECK_CLAIM_3_INPUT_OPENINGS: &[&str] = &["stage5.input.stage4.field_registers.FieldRegistersVal"];
...
pub const STAGE5_SUMCHECK_CLAIMS: &[Stage5SumcheckClaimPlan] = &[
    ...
    Stage5SumcheckClaimPlan { symbol: "stage5.field_registers_val_evaluation.input", stage: "stage5", domain: "jolt.trace_domain", num_rounds: 18, degree: 3, claim: "stage5.field_registers_val_evaluation.field_registers_val", kernel: Some("jolt.cpu.stage5.field_registers_val_evaluation"), relation: None, claim_value: "stage5.input.stage4.field_registers.FieldRegistersVal", input_openings: STAGE5_SUMCHECK_CLAIM_3_INPUT_OPENINGS },
];
...
pub const STAGE5_POINT_CONCAT_10_INPUTS: &[&str] = &[
    ...
    "stage5.field_registers_val_evaluation.instance",
];
...
pub const STAGE5_POINT_CONCATS: &[Stage5PointConcatPlan] = &[
    ...
    Stage5PointConcatPlan { symbol: "stage5.field_registers_val_evaluation.point.FieldRdWa", layout: "register_address_then_cycle", arity: 22, inputs: STAGE5_POINT_CONCAT_10_INPUTS },
];
...
pub const STAGE5_OPENING_BATCH_0_ORDERED_CLAIMS: &[&str] = &[
    ...
    "stage5.field_registers_val_evaluation.opening.FieldRdInc",
    "stage5.field_registers_val_evaluation.opening.FieldRdWa",
];
...
pub const STAGE5_OPENING_BATCHES: &[Stage5OpeningBatchPlan] = &[
    Stage5OpeningBatchPlan { symbol: "stage5.openings", stage: "stage5", proof_slot: "stage5.openings", policy: "jolt_stage5_output_order", count: 54, ordered_claims: STAGE5_OPENING_BATCH_0_ORDERED_CLAIMS, claim_operands: STAGE5_OPENING_BATCH_0_CLAIM_OPERANDS },
];
