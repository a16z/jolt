...
use jolt_verifier::stages::{
    ...
    stage3::{
        ...
        stage3_input_claims, Stage3ExpectedOutputClaims, Stage3ExpectedOutputRequest,
        Stage3InputClaimRequest, Stage3InputClaims,
    },
};
    ...
    T: Transcript<Challenge = F>,
{
    ...
    let expected_final_claim =
        stage3_expected_batch_final_claim(&batch.batching_coefficients, &expected)?;
