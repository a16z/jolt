...
pub const STAGE3_FIELD_EXPR_OPERANDS_19: &[&str] = &["stage3.field_registers.gamma"];

pub const STAGE3_FIELD_EXPR_OPERANDS_20: &[&str] = &[
    "stage3.field_registers.gamma",
    "stage3.input.stage1.FieldRs1Value",
];

pub const STAGE3_FIELD_EXPR_OPERANDS_21: &[&str] = &[
    "stage3.field_registers.gamma2",
    "stage3.input.stage1.FieldRs2Value",
];

pub const STAGE3_FIELD_EXPR_OPERANDS_22: &[&str] = &[
    "stage3.input.stage1.FieldRdValue",
    "stage3.field_registers.term.FieldRs1Value",
];

pub const STAGE3_FIELD_EXPR_OPERANDS_23: &[&str] = &[
    "stage3.field_registers.partial.FieldRdValueFieldRs1Value",
    "stage3.field_registers.term.FieldRs2Value",
];
...
pub const STAGE3_FIELD_EXPRS: &[Stage3FieldExprPlan] = &[
    ...
    Stage3FieldExprPlan { symbol: "stage3.field_registers.gamma2", kind: "op", formula: "field.pow:2", operand_names: STAGE3_FIELD_EXPR_OPERANDS_19, operands: STAGE3_FIELD_EXPR_OPERANDS_19 },
    Stage3FieldExprPlan { symbol: "stage3.field_registers.term.FieldRs1Value", kind: "op", formula: "field.mul", operand_names: STAGE3_FIELD_EXPR_OPERANDS_20, operands: STAGE3_FIELD_EXPR_OPERANDS_20 },
    Stage3FieldExprPlan { symbol: "stage3.field_registers.term.FieldRs2Value", kind: "op", formula: "field.mul", operand_names: STAGE3_FIELD_EXPR_OPERANDS_21, operands: STAGE3_FIELD_EXPR_OPERANDS_21 },
    Stage3FieldExprPlan { symbol: "stage3.field_registers.partial.FieldRdValueFieldRs1Value", kind: "op", formula: "field.add", operand_names: STAGE3_FIELD_EXPR_OPERANDS_22, operands: STAGE3_FIELD_EXPR_OPERANDS_22 },
    Stage3FieldExprPlan { symbol: "stage3.field_registers.claim_expr", kind: "op", formula: "field.add", operand_names: STAGE3_FIELD_EXPR_OPERANDS_23, operands: STAGE3_FIELD_EXPR_OPERANDS_23 },
];
pub const STAGE3_KERNELS: &[Stage3KernelPlan] = &[
    ...
    Stage3KernelPlan { symbol: "jolt.cpu.stage3.field_registers_claim_reduction", relation: "jolt.stage3.field_registers_claim_reduction", kind: "sumcheck", backend: "cpu", abi: "jolt_stage3_field_registers_claim_reduction" },
...
pub const STAGE3_SUMCHECK_CLAIMS: &[Stage3SumcheckClaimPlan] = &[
    ...
    Stage3SumcheckClaimPlan { symbol: "stage3.field_registers_claim_reduction.input", stage: "stage3", domain: "jolt.trace_domain", num_rounds: 18, degree: 2, claim: "stage3.field_registers.weighted_field_register_values", kernel: Some("jolt.cpu.stage3.field_registers_claim_reduction"), relation: None, claim_value: "stage3.field_registers.claim_expr", input_openings: STAGE3_SUMCHECK_CLAIM_3_INPUT_OPENINGS },
];
pub const STAGE3_SUMCHECK_BATCH_0_ORDERED_CLAIMS: &[&str] = &[
    ...
    "stage3.field_registers_claim_reduction.input",
];
...
pub const STAGE3_OPENING_BATCH_0_ORDERED_CLAIMS: &[&str] = &[
    ...
    "stage3.field_registers_claim_reduction.opening.FieldRdValue",
    "stage3.field_registers_claim_reduction.opening.FieldRs1Value",
    "stage3.field_registers_claim_reduction.opening.FieldRs2Value",
];
