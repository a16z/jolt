...
impl WitnessProvider<Fr, TestNamespace> for RaPushforwardTestWitness {
    fn describe_oracle(
        ...
        Err(WitnessError::UnsupportedFrontier {
            frontier: "ra pushforward test describe",
        })
    }
    ...
    fn view_requirements(
        ...
        Err(WitnessError::UnsupportedFrontier {
            frontier: "ra pushforward test view requirements",
        })
    }
    ...
    fn oracle_view(
        ...
        Err(WitnessError::UnsupportedFrontier {
            frontier: "ra pushforward test oracle view",
        })
    }
...
impl WitnessProvider<Fr, TestNamespace> for TestMultiOracleWitness {
    ...
    fn oracle_view(
        ...
        Err(WitnessError::UnsupportedFrontier {
            frontier: "cpu test multi oracle views",
        })
    }
