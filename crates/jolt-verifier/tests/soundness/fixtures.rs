...
pub fn metadata(id: FixtureId) -> FixtureMetadata {
    match id {
        FixtureId::PublicIoMismatch => FixtureMetadata {
            ...
            notes: "Prover-transitivity target for preamble and public I/O binding.",
        },
        FixtureId::TrustedAdviceMismatch => FixtureMetadata {
            ...
            expected_prover_accepts: false,
            notes: "Prover-transitivity target for trusted advice commitment binding.",
        },
        ...
        | FixtureId::CommittedMulDivSmall => FixtureMetadata {
            ...
            expected_prover_accepts: !matches!(id, FixtureId::ZkStage1Prefix),
