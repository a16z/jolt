...
pub const COMMITMENT_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.commitments.frame",
        VerifierPhase::Stage1,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "real verifier fixture replaces one NARG commitment with another and rejects before acceptance",
    ),
    checked_standard(
        ...
        TamperCoverage::Active,
        "real verifier fixture truncates the commitment NARG frame and rejects before acceptance",
    ),
    checked_standard(
        ...
        TamperCoverage::Active,
        "real verifier fixture extends the commitment NARG frame and rejects before acceptance",
    ),
    checked_standard(
        ...
        TamperCoverage::Active,
        "real verifier fixture swaps NARG commitments and rejects before acceptance",
    ),
    checked_standard(
        "proof.untrusted_advice_commitment",
        "proof.narg.untrusted_advice_commitment",
        VerifierPhase::Stage1,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Deferred,
...
pub const PROOF_SHAPE_TARGETS: &[TamperTarget] = &[checked_both(
...
pub const STAGE1_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage1_uni_skip.frames[*]",
        VerifierPhase::Stage1,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every full uni-skip NARG frame",
    ),
    checked_standard(
        ...
        TamperCoverage::Active,
        "prover-fixture test removes a uni-skip NARG frame",
    ),
    checked_standard(
        ...
        TamperCoverage::Active,
        "prover-fixture test appends a uni-skip NARG frame",
    ),
    checked_standard(
        "stage1.remainder.round_polynomial",
        "proof.narg.stage1_remainder.frames[*]",
        VerifierPhase::Stage1,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed remainder NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a remainder NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a remainder NARG frame",
    ),
    checked_standard(
...
pub const STAGE2_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage2_product_uniskip.frames[*]",
        VerifierPhase::Stage2,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every product uni-skip NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a product uni-skip NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a product uni-skip NARG frame",
    ),
    checked_standard(
        "stage2.batch.round_polynomial",
        "proof.narg.stage2_batch.frames[*]",
        VerifierPhase::Stage2,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 2 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 2 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 2 batch NARG frame",
    ),
    checked_standard(
...
pub const STAGE3_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage3_batch.frames[*]",
        VerifierPhase::Stage3,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 3 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 3 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 3 batch NARG frame",
    ),
    checked_standard(
        "stage3.claims.shift",
        "claims.stage3.shift.*",
...
pub const STAGE4_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage4_batch.frames[*]",
        VerifierPhase::Stage4,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 4 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 4 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 4 batch NARG frame",
    ),
    checked_standard(
...
pub const STAGE5_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage5_batch.frames[*]",
        VerifierPhase::Stage5,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 5 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 5 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 5 batch NARG frame",
    ),
    checked_standard(
...
pub const STAGE6_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage6_address_phase.frames[*]",
        VerifierPhase::Stage6,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 6 address-phase NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 6 address-phase NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 6 address-phase NARG frame",
    ),
    checked_standard(
        "stage6.cycle_phase.round_polynomial",
        "proof.narg.stage6_cycle_phase.frames[*]",
        VerifierPhase::Stage6,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 6 cycle-phase NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 6 cycle-phase NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 6 cycle-phase NARG frame",
    ),
    checked_standard(
...
pub const STAGE7_TARGETS: &[TamperTarget] = &[
    checked_standard(
        ...
        "proof.narg.stage7_batch.frames[*]",
        VerifierPhase::Stage7,
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "prover-fixture test mutates every compressed Stage 7 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::TruncateVector,
        TamperCoverage::Active,
        "prover-fixture test removes a Stage 7 batch NARG frame",
    ),
    checked_standard(
        ...
        MutationStrategy::ExtendVector,
        TamperCoverage::Active,
        "prover-fixture test appends a Stage 7 batch NARG frame",
    ),
    checked_standard(
...
pub const FUTURE_STAGE_TARGETS: &[TamperTarget] = &[
    ...
    zk_target(
        "zk.blindfold_proof",
        "proof.narg.blindfold",
        MutationStrategy::ReplaceProofPayload,
        TamperCoverage::Active,
        "verifier-native ZK fixture mutates the BlindFold NARG payload",
    ),
    zk_target(
