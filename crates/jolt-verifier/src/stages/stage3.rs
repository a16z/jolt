...
pub const STAGE3_FIELD_EXPRS: &[Stage3FieldExprPlan] = &[
    ...
    Stage3FieldExprPlan { symbol: "stage3.field_reg.gamma2", kind: "op", formula: "field.pow:2", operands: "stage3.field_reg.gamma" },
    Stage3FieldExprPlan { symbol: "stage3.field_reg.term.FieldRs1Value", kind: "op", formula: "field.mul", operands: "stage3.field_reg.gamma|stage3.input.stage1.FieldRs1Value" },
    Stage3FieldExprPlan { symbol: "stage3.field_reg.term.FieldRs2Value", kind: "op", formula: "field.mul", operands: "stage3.field_reg.gamma2|stage3.input.stage1.FieldRs2Value" },
    Stage3FieldExprPlan { symbol: "stage3.field_reg.partial.FieldRdWriteValueFieldRs1Value", kind: "op", formula: "field.add", operands: "stage3.input.stage1.FieldRdWriteValue|stage3.field_reg.term.FieldRs1Value" },
    Stage3FieldExprPlan { symbol: "stage3.field_reg.claim_expr", kind: "op", formula: "field.add", operands: "stage3.field_reg.partial.FieldRdWriteValueFieldRs1Value|stage3.field_reg.term.FieldRs2Value" },
];
pub const STAGE3_SUMCHECK_CLAIMS: &[Stage3SumcheckClaimPlan] = &[
    ...
    Stage3SumcheckClaimPlan { symbol: "stage3.field_reg_claim_reduction.input", stage: "stage3", domain: "jolt.trace_domain", num_rounds: 18, degree: 2, claim: "stage3.field_reg.weighted_field_reg_values", kernel: None, relation: Some("jolt.stage3.field_reg_claim_reduction"), claim_value: "stage3.field_reg.claim_expr", input_openings: "stage3.input.stage1.FieldRdWriteValue|stage3.input.stage1.FieldRs1Value|stage3.input.stage1.FieldRs2Value" },
];
