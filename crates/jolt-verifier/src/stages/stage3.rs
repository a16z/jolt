...
pub const STAGE3_RELATION_OUTPUTS: &[Stage3RelationOutputPlan] = &[
    Stage3RelationOutputPlan { relation: Stage3RelationKind::Stage3SpartanShift, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage3.spartan_shift.output.eq.NextPC", index: 0 }, bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage3.spartan_shift.output.eq.NextIsNoop", index: 1 }], eval_families: &[], product_families: &[], function_families: &[], local_scalars: &[], expected_output: "stage3.spartan_shift.output.claim_expr" },
    Stage3RelationOutputPlan { relation: Stage3RelationKind::Stage3InstructionInput, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage3.instruction_input.output.eq.LeftInstructionInput", index: 2 }], eval_families: &[], product_families: &[], function_families: &[], local_scalars: &[], expected_output: "stage3.instruction_input.output.claim_expr" },
    Stage3RelationOutputPlan { relation: Stage3RelationKind::Stage3RegistersClaimReduction, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage3.registers.output.eq.RdWriteValue", index: 3 }], eval_families: &[], product_families: &[], function_families: &[], local_scalars: &[], expected_output: "stage3.registers.output.claim_expr" },
];
