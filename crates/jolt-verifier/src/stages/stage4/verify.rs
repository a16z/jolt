    ...
    T: Transcript<Challenge = PCS::Field>,
{
    ...
    let claims = &proof.transparent_claims()?.stage4;
    ...
    let expected_final_claim = *registers_coefficient * expected_outputs.registers_read_write
