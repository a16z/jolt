...
pub const STAGE5_SUMCHECK_CLAIMS: &[Stage5SumcheckClaimPlan] = &[
    ...
    Stage5SumcheckClaimPlan { symbol: "stage5.field_reg_val_evaluation.input", stage: "stage5", domain: "jolt.trace_domain", num_rounds: 18, degree: 3, claim: "stage5.field_reg_val_evaluation.field_reg_val", kernel: None, relation: Some("jolt.stage5.field_reg_val_evaluation"), claim_value: "stage5.input.stage4.field_reg.FieldRegVal", input_openings: "stage5.input.stage4.field_reg.FieldRegVal" },
];
...
pub const STAGE5_POINT_CONCATS: &[Stage5PointConcatPlan] = &[
    ...
    Stage5PointConcatPlan { symbol: "stage5.field_reg_val_evaluation.point.FrdWa", layout: "field_reg_address_then_cycle", arity: 22, inputs: "stage5.field_reg_val_evaluation.point.FieldRegAddress|stage5.field_reg_val_evaluation.instance" },
];
pub const STAGE5_OPENING_CLAIMS: &[Stage5OpeningClaimPlan] = &[
    ...
    Stage5OpeningClaimPlan { symbol: "stage5.instruction_read_raf.opening.LookupTableFlag_40", oracle: "LookupTableFlag_40", domain: "jolt.trace_domain", point_arity: 18, claim_kind: "virtual", point_source: "stage5.instruction_read_raf.point.Cycle", eval_source: "stage5.instruction_read_raf.eval.LookupTableFlag_40" },
