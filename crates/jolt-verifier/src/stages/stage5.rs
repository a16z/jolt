...
pub const STAGE5_RELATION_OUTPUTS: &[Stage5RelationOutputPlan] = &[
    ...
    Stage5RelationOutputPlan { relation: Stage5RelationKind::Stage5RegistersValEvaluation, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage5.registers_val_evaluation.output.lt.RegistersValCycle", index: 3 }], local_scalars: &[], expected_output: "stage5.registers_val_evaluation.output.claim_expr" },
    Stage5RelationOutputPlan { relation: Stage5RelationKind::Stage5InstructionReadRaf, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage5.instruction_read_raf.output.eq.LookupOutputCycle", index: 4 }], local_scalars: STAGE5_RELATION_OUTPUT_2_LOCAL_SCALARS, expected_output: "stage5.instruction_read_raf.output.claim_expr" },
];
