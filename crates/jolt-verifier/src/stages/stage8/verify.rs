...
use super::{inputs::Deps, outputs::Stage8Output};
use crate::{
...
where
    ...
    PCS::Output: Clone + HomomorphicCommitment<PCS::Field>,
    ...
    T: Transcript<Challenge = PCS::Field>,
{
...

    {
        ...
        push_opening(
            ...
            deps.stage6.output_claims.inc_claim_reduction.ram_inc,
        ...
        push_opening(
            ...
            deps.stage6.output_claims.inc_claim_reduction.rd_inc,
            dense_embedding_scale,
        );
