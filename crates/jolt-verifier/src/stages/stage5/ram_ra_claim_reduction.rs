...
//!
//! Owns the RAM-RA reduction's point splice, public-value computation, and
//! address-agreement check. The consumed/produced claim structs and their
//! `InputClaims`/`OutputClaims` impls are defined in this module (generated by the
//! cell-aware derives).
