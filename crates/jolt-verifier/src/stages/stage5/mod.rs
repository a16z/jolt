...
pub use verify::{
    ...
    stage5_instruction_read_raf_dependencies, stage5_value_opening_points, verify,
    ...
    Stage5InstructionOpeningPoints, Stage5InstructionReadRafDependencyRequest,
    Stage5ValueOpeningPointRequest, Stage5ValueOpeningPoints,
};
