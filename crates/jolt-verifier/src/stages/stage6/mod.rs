...
pub use verify::{
    ...
    stage6_public_output, stage6_ram_reduced_opening_point, stage6_stage1_cycle_binding,
    stage6_stage1_gamma_count, stage6_stage2_gamma_count, stage6_stage3_gamma_count,
    stage6_stage4_gamma_count, stage6_stage5_gamma_count, stage6_stage5_ram_reduced_opening_point,
    ...
    Stage6BatchPointContext, Stage6BatchPointInputs, Stage6BatchPoints, Stage6BooleanityReference,
    Stage6BytecodeRaPoint, Stage6BytecodeReadRafExpectedOutputInputs, Stage6BytecodeReadRafPoint,
    Stage6BytecodeRegisterPoints, Stage6ClearOutputRequest, Stage6IncClaimReductionCyclePoints,
    Stage6InputClaimChallengeValues, Stage6InstructionReadRafPoint, Stage6PostAddressChallenges,
