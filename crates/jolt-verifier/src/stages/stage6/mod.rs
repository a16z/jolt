...
pub use verify::{
    ...
    stage6_bytecode_ra_point, stage6_bytecode_read_raf_expected_output,
    stage6_bytecode_read_raf_output_coefficient, stage6_bytecode_read_raf_point,
    stage6_bytecode_register_points, stage6_clear_output, stage6_expected_final_claim,
    stage6_expected_output_claim_values, stage6_inc_claim_reduction_cycle_points,
    stage6_inc_claim_reduction_expected_output,
    stage6_instruction_ra_virtualization_expected_output, stage6_instruction_read_raf_point,
    stage6_output_claim_values, stage6_public_output,
    stage6_ram_hamming_booleanity_expected_output, stage6_ram_ra_virtualization_expected_output,
    stage6_ram_reduced_opening_point, stage6_stage1_cycle_binding, stage6_stage1_gamma_count,
    stage6_stage2_gamma_count, stage6_stage3_gamma_count, stage6_stage4_gamma_count,
    stage6_stage5_gamma_count, stage6_stage5_ram_reduced_opening_point,
    stage6_transcript_challenges, stage6_validate_dependencies,
    stage6_zk_instruction_read_raf_point, stage6_zk_stage5_ram_reduced_opening_point, verify,
    ...
    Stage6BooleanityExpectedOutputInputs, Stage6BooleanityReference, Stage6BytecodeRaPoint,
    Stage6BytecodeReadRafExpectedOutputInputs, Stage6BytecodeReadRafOutputCoefficientInputs,
    Stage6BytecodeReadRafPoint, Stage6BytecodeRegisterPoints, Stage6ClearOutputRequest,
    Stage6IncClaimReductionCyclePoints, Stage6IncClaimReductionExpectedOutputInputs,
    Stage6InputClaimChallengeValues, Stage6InstructionRaVirtualizationExpectedOutputInputs,
    Stage6InstructionReadRafPoint, Stage6RamRaVirtualizationExpectedOutputInputs,
