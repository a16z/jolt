...
const STAGE6_BYTECODE_STAGES: &[Stage67BytecodeStagePlan] = &[
    ...
    Stage67BytecodeStagePlan { gamma: "stage6.bytecode_read_raf.stage3_gamma", cycle_point: "stage6.input.stage3.spartan_shift.UnexpandedPC", register_point: None, terms: STAGE6_BYTECODE_STAGE3_TERMS },
    Stage67BytecodeStagePlan { gamma: "stage6.bytecode_read_raf.stage4_gamma", cycle_point: "stage6.input.stage4.Rs1Ra", register_point: Some("stage6.input.stage4.Rs1Ra"), terms: STAGE6_BYTECODE_STAGE4_TERMS },
...
const STAGE6_BYTECODE_OUTPUT_TERMS: &[Stage67BytecodeOutputTermPlan] = &[
    Stage67BytecodeOutputTermPlan::StageValue { stage_index: 0, gamma_power: 0, identity_gamma_power: Some(5) },
    Stage67BytecodeOutputTermPlan::StageValue { stage_index: 1, gamma_power: 1, identity_gamma_power: None },
    Stage67BytecodeOutputTermPlan::StageValue { stage_index: 2, gamma_power: 2, identity_gamma_power: Some(4) },
    Stage67BytecodeOutputTermPlan::StageValue { stage_index: 3, gamma_power: 3, identity_gamma_power: None },
    Stage67BytecodeOutputTermPlan::StageValue { stage_index: 4, gamma_power: 4, identity_gamma_power: None },
    Stage67BytecodeOutputTermPlan::Entry { gamma_power: 7 },
];
...
pub const STAGE6_PROGRAM_STEPS: &[Stage6ProgramStepPlan] = &[
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.bytecode_read_raf.gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.bytecode_read_raf.stage1_gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.bytecode_read_raf.stage2_gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.bytecode_read_raf.stage3_gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.bytecode_read_raf.stage4_gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.bytecode_read_raf.stage5_gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.booleanity.gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.instruction_ra_virtual.gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::TranscriptSqueeze, symbol: "stage6.inc_claim_reduction.gamma" },
    Stage6ProgramStepPlan { kind: Stage6ProgramStepKind::SumcheckDriver, symbol: "stage6.sumcheck" },
];

pub const STAGE6_TRANSCRIPT_SQUEEZES: &[Stage6TranscriptSqueezePlan] = &[
    Stage6TranscriptSqueezePlan { symbol: "stage6.bytecode_read_raf.gamma", label: "bc_raf_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.bytecode_read_raf.stage1_gamma", label: "bc_raf_stage1_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.bytecode_read_raf.stage2_gamma", label: "bc_raf_stage2_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.bytecode_read_raf.stage3_gamma", label: "bc_raf_stage3_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.bytecode_read_raf.stage4_gamma", label: "bc_raf_stage4_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.bytecode_read_raf.stage5_gamma", label: "bc_raf_stage5_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.booleanity.gamma", label: "booleanity_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.instruction_ra_virtual.gamma", label: "inst_ra_virtual_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
    Stage6TranscriptSqueezePlan { symbol: "stage6.inc_claim_reduction.gamma", label: "inc_reduction_gamma", kind: Stage6TranscriptSqueezeKind::ChallengeScalar, count: 1 },
];
...
pub const STAGE6_OPENING_INPUTS: &[Stage6OpeningInputPlan] = &[
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.UnexpandedPC", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.UnexpandedPC", oracle: "UnexpandedPC", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.Imm", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.Imm", oracle: "Imm", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagAddOperands", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagAddOperands", oracle: "OpFlagAddOperands", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagSubtractOperands", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagSubtractOperands", oracle: "OpFlagSubtractOperands", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagMultiplyOperands", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagMultiplyOperands", oracle: "OpFlagMultiplyOperands", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagLoad", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagLoad", oracle: "OpFlagLoad", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagStore", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagStore", oracle: "OpFlagStore", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagJump", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagJump", oracle: "OpFlagJump", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagWriteLookupOutputToRD", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagWriteLookupOutputToRD", oracle: "OpFlagWriteLookupOutputToRD", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagVirtualInstruction", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagVirtualInstruction", oracle: "OpFlagVirtualInstruction", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagAssert", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagAssert", oracle: "OpFlagAssert", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagDoNotUpdateUnexpandedPC", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagDoNotUpdateUnexpandedPC", oracle: "OpFlagDoNotUpdateUnexpandedPC", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagAdvice", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagAdvice", oracle: "OpFlagAdvice", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagIsCompressed", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagIsCompressed", oracle: "OpFlagIsCompressed", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagIsFirstInSequence", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagIsFirstInSequence", oracle: "OpFlagIsFirstInSequence", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.OpFlagIsLastInSequence", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.OpFlagIsLastInSequence", oracle: "OpFlagIsLastInSequence", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage2.OpFlagJump", source_stage: "stage2", source_claim: "stage2.product_virtual.remainder.opening.OpFlagJump", oracle: "OpFlagJump", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage2.InstructionFlagBranch", source_stage: "stage2", source_claim: "stage2.product_virtual.remainder.opening.InstructionFlagBranch", oracle: "InstructionFlagBranch", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage2.OpFlagWriteLookupOutputToRD", source_stage: "stage2", source_claim: "stage2.product_virtual.remainder.opening.OpFlagWriteLookupOutputToRD", oracle: "OpFlagWriteLookupOutputToRD", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage2.OpFlagVirtualInstruction", source_stage: "stage2", source_claim: "stage2.product_virtual.remainder.opening.OpFlagVirtualInstruction", oracle: "OpFlagVirtualInstruction", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.instruction_input.Imm", source_stage: "stage3", source_claim: "stage3.instruction_input.opening.Imm", oracle: "Imm", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.spartan_shift.UnexpandedPC", source_stage: "stage3", source_claim: "stage3.spartan_shift.opening.UnexpandedPC", oracle: "UnexpandedPC", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.instruction_input.InstructionFlagLeftOperandIsRs1Value", source_stage: "stage3", source_claim: "stage3.instruction_input.opening.InstructionFlagLeftOperandIsRs1Value", oracle: "InstructionFlagLeftOperandIsRs1Value", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.instruction_input.InstructionFlagLeftOperandIsPC", source_stage: "stage3", source_claim: "stage3.instruction_input.opening.InstructionFlagLeftOperandIsPC", oracle: "InstructionFlagLeftOperandIsPC", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.instruction_input.InstructionFlagRightOperandIsRs2Value", source_stage: "stage3", source_claim: "stage3.instruction_input.opening.InstructionFlagRightOperandIsRs2Value", oracle: "InstructionFlagRightOperandIsRs2Value", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.instruction_input.InstructionFlagRightOperandIsImm", source_stage: "stage3", source_claim: "stage3.instruction_input.opening.InstructionFlagRightOperandIsImm", oracle: "InstructionFlagRightOperandIsImm", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.spartan_shift.InstructionFlagIsNoop", source_stage: "stage3", source_claim: "stage3.spartan_shift.opening.InstructionFlagIsNoop", oracle: "InstructionFlagIsNoop", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.spartan_shift.OpFlagVirtualInstruction", source_stage: "stage3", source_claim: "stage3.spartan_shift.opening.OpFlagVirtualInstruction", oracle: "OpFlagVirtualInstruction", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.spartan_shift.OpFlagIsFirstInSequence", source_stage: "stage3", source_claim: "stage3.spartan_shift.opening.OpFlagIsFirstInSequence", oracle: "OpFlagIsFirstInSequence", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage4.RdWa", source_stage: "stage4", source_claim: "stage4.registers_read_write.opening.RdWa", oracle: "RdWa", domain: "jolt.stage4_registers_rw_domain", point_arity: 23, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage4.Rs1Ra", source_stage: "stage4", source_claim: "stage4.registers_read_write.opening.Rs1Ra", oracle: "Rs1Ra", domain: "jolt.stage4_registers_rw_domain", point_arity: 23, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage4.Rs2Ra", source_stage: "stage4", source_claim: "stage4.registers_read_write.opening.Rs2Ra", oracle: "Rs2Ra", domain: "jolt.stage4_registers_rw_domain", point_arity: 23, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.registers_val_evaluation.RdWa", source_stage: "stage5", source_claim: "stage5.registers_val_evaluation.opening.RdWa", oracle: "RdWa", domain: "jolt.stage4_registers_rw_domain", point_arity: 23, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.InstructionRafFlag", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRafFlag", oracle: "InstructionRafFlag", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_0", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_0", oracle: "LookupTableFlag_0", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_1", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_1", oracle: "LookupTableFlag_1", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_2", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_2", oracle: "LookupTableFlag_2", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_3", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_3", oracle: "LookupTableFlag_3", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_4", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_4", oracle: "LookupTableFlag_4", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_5", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_5", oracle: "LookupTableFlag_5", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_6", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_6", oracle: "LookupTableFlag_6", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_7", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_7", oracle: "LookupTableFlag_7", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_8", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_8", oracle: "LookupTableFlag_8", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_9", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_9", oracle: "LookupTableFlag_9", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_10", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_10", oracle: "LookupTableFlag_10", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_11", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_11", oracle: "LookupTableFlag_11", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_12", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_12", oracle: "LookupTableFlag_12", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_13", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_13", oracle: "LookupTableFlag_13", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_14", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_14", oracle: "LookupTableFlag_14", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_15", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_15", oracle: "LookupTableFlag_15", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_16", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_16", oracle: "LookupTableFlag_16", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_17", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_17", oracle: "LookupTableFlag_17", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_18", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_18", oracle: "LookupTableFlag_18", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_19", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_19", oracle: "LookupTableFlag_19", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_20", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_20", oracle: "LookupTableFlag_20", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_21", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_21", oracle: "LookupTableFlag_21", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_22", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_22", oracle: "LookupTableFlag_22", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_23", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_23", oracle: "LookupTableFlag_23", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_24", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_24", oracle: "LookupTableFlag_24", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_25", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_25", oracle: "LookupTableFlag_25", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_26", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_26", oracle: "LookupTableFlag_26", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_27", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_27", oracle: "LookupTableFlag_27", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_28", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_28", oracle: "LookupTableFlag_28", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_29", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_29", oracle: "LookupTableFlag_29", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_30", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_30", oracle: "LookupTableFlag_30", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_31", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_31", oracle: "LookupTableFlag_31", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_32", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_32", oracle: "LookupTableFlag_32", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_33", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_33", oracle: "LookupTableFlag_33", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_34", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_34", oracle: "LookupTableFlag_34", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_35", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_35", oracle: "LookupTableFlag_35", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_36", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_36", oracle: "LookupTableFlag_36", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_37", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_37", oracle: "LookupTableFlag_37", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_38", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_38", oracle: "LookupTableFlag_38", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_39", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_39", oracle: "LookupTableFlag_39", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.LookupTableFlag_40", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.LookupTableFlag_40", oracle: "LookupTableFlag_40", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.PC", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.PC", oracle: "PC", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage3.spartan_shift.PC", source_stage: "stage3", source_claim: "stage3.spartan_shift.opening.PC", oracle: "PC", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.ram_ra_claim_reduction.RamRa", source_stage: "stage5", source_claim: "stage5.ram_ra_claim_reduction.opening.RamRa", oracle: "RamRa", domain: "jolt.stage2_ram_rw_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_0", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_0", oracle: "InstructionRa_0", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_1", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_1", oracle: "InstructionRa_1", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_2", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_2", oracle: "InstructionRa_2", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_3", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_3", oracle: "InstructionRa_3", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_4", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_4", oracle: "InstructionRa_4", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_5", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_5", oracle: "InstructionRa_5", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_6", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_6", oracle: "InstructionRa_6", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.instruction_read_raf.InstructionRa_7", source_stage: "stage5", source_claim: "stage5.instruction_read_raf.opening.InstructionRa_7", oracle: "InstructionRa_7", domain: "jolt.stage5_instruction_ra_chunk_domain", point_arity: 32, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage1.LookupOutput", source_stage: "stage1", source_claim: "stage1.outer_remaining.opening.LookupOutput", oracle: "LookupOutput", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage2.ram_read_write.RamInc", source_stage: "stage2", source_claim: "stage2.ram_read_write.opening.RamInc", oracle: "RamInc", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Committed },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage4.ram_val_check.RamInc", source_stage: "stage4", source_claim: "stage4.ram_val_check.opening.RamInc", oracle: "RamInc", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Committed },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage4.registers_read_write.RdInc", source_stage: "stage4", source_claim: "stage4.registers_read_write.opening.RdInc", oracle: "RdInc", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Committed },
    Stage6OpeningInputPlan { symbol: "stage6.input.stage5.registers_val_evaluation.RdInc", source_stage: "stage5", source_claim: "stage5.registers_val_evaluation.opening.RdInc", oracle: "RdInc", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Committed },
];
...
pub const STAGE6_SUMCHECK_CLAIMS: &[Stage6SumcheckClaimPlan] = &[
    Stage6SumcheckClaimPlan { symbol: "stage6.bytecode_read_raf.input", stage: "stage6", domain: "jolt.stage6_bytecode_read_raf_domain", num_rounds: 26, degree: 4, claim: "stage6.bytecode_read_raf.weighted_prior_stage_values", kernel: None, relation: Some(Stage6RelationKind::Stage6BytecodeReadRaf), claim_value: "stage6.bytecode_read_raf.claim_expr.partial76" },
    Stage6SumcheckClaimPlan { symbol: "stage6.booleanity.input", stage: "stage6", domain: "jolt.stage6_booleanity_domain", num_rounds: 20, degree: 3, claim: "stage6.booleanity.zero", kernel: None, relation: Some(Stage6RelationKind::Stage6Booleanity), claim_value: "stage6.zero" },
    Stage6SumcheckClaimPlan { symbol: "stage6.hamming_booleanity.input", stage: "stage6", domain: "jolt.trace_domain", num_rounds: 16, degree: 3, claim: "stage6.hamming_booleanity.zero", kernel: None, relation: Some(Stage6RelationKind::Stage6HammingBooleanity), claim_value: "stage6.zero" },
    Stage6SumcheckClaimPlan { symbol: "stage6.ram_ra_virtual.input", stage: "stage6", domain: "jolt.trace_domain", num_rounds: 16, degree: 5, claim: "stage6.ram_ra_virtual.weighted_ram_ra", kernel: None, relation: Some(Stage6RelationKind::Stage6RamRaVirtual), claim_value: "stage6.input.stage5.ram_ra_claim_reduction.RamRa" },
...
pub const STAGE6_SUMCHECK_BATCHES: &[Stage6SumcheckBatchPlan] = &[
    Stage6SumcheckBatchPlan { symbol: "stage6.batch", stage: "stage6", proof_slot: "stage6.sumcheck", policy: "jolt_core_stage6_aligned", count: 6, claim_operands: STAGE6_SUMCHECK_BATCH_0_CLAIM_OPERANDS, claim_label: "sumcheck_claim", round_label: "sumcheck_poly", round_schedule: STAGE6_SUMCHECK_BATCH_0_ROUND_SCHEDULE },
];
...
pub const STAGE6_POINT_CONCATS: &[Stage6PointConcatPlan] = &[
    ...
    Stage6PointConcatPlan { symbol: "stage6.bytecode_read_raf.point.BytecodeRa_0", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.bytecode_read_raf.point.BytecodeRa_0.address", "stage6.bytecode_read_raf.point.Cycle"] },
    Stage6PointConcatPlan { symbol: "stage6.bytecode_read_raf.point.BytecodeRa_1", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.bytecode_read_raf.point.BytecodeRa_1.address", "stage6.bytecode_read_raf.point.Cycle"] },
    Stage6PointConcatPlan { symbol: "stage6.bytecode_read_raf.point.BytecodeRa_2", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.bytecode_read_raf.point.BytecodeRa_2.address", "stage6.bytecode_read_raf.point.Cycle"] },
    Stage6PointConcatPlan { symbol: "stage6.ram_ra_virtual.point.RamRa_0", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.ram_ra_virtual.point.RamRa_0.address", "stage6.ram_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.ram_ra_virtual.point.RamRa_1", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.ram_ra_virtual.point.RamRa_1.address", "stage6.ram_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.ram_ra_virtual.point.RamRa_2", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.ram_ra_virtual.point.RamRa_2.address", "stage6.ram_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.ram_ra_virtual.point.RamRa_3", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.ram_ra_virtual.point.RamRa_3.address", "stage6.ram_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_0", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_0.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_1", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_1.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_2", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_2.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_3", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_3.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_4", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_4.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_5", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_5.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_6", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_6.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_7", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_7.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_8", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_8.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_9", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_9.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_10", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_10.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_11", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_11.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_12", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_12.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_13", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_13.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_14", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_14.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_15", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_15.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_16", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_16.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_17", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_17.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_18", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_18.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_19", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_19.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_20", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_20.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_21", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_21.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_22", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_22.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_23", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_23.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_24", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_24.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_25", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_25.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_26", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_26.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_27", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_27.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_28", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_28.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_29", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_29.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_30", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_30.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.instruction_ra_virtual.point.InstructionRa_31", layout: "address_chunk_then_cycle", arity: 20, inputs: &["stage6.instruction_ra_virtual.point.InstructionRa_31.address", "stage6.instruction_ra_virtual.instance"] },
    Stage6PointConcatPlan { symbol: "stage6.booleanity.output.point", layout: "address_prefix_then_cycle", arity: 20, inputs: &["stage6.booleanity.output.point.Address", "stage6.booleanity.output.point.Cycle"] },
];
pub const STAGE6_OPENING_CLAIMS: &[Stage6OpeningClaimPlan] = &[
    Stage6OpeningClaimPlan { symbol: "stage6.bytecode_read_raf.opening.BytecodeRa_0", oracle: "BytecodeRa_0", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.bytecode_read_raf.point.BytecodeRa_0", eval_source: "stage6.bytecode_read_raf.eval.BytecodeRa_0" },
    Stage6OpeningClaimPlan { symbol: "stage6.bytecode_read_raf.opening.BytecodeRa_1", oracle: "BytecodeRa_1", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.bytecode_read_raf.point.BytecodeRa_1", eval_source: "stage6.bytecode_read_raf.eval.BytecodeRa_1" },
    Stage6OpeningClaimPlan { symbol: "stage6.bytecode_read_raf.opening.BytecodeRa_2", oracle: "BytecodeRa_2", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.bytecode_read_raf.point.BytecodeRa_2", eval_source: "stage6.bytecode_read_raf.eval.BytecodeRa_2" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_0", oracle: "InstructionRa_0", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_0" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_1", oracle: "InstructionRa_1", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_1" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_2", oracle: "InstructionRa_2", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_2" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_3", oracle: "InstructionRa_3", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_3" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_4", oracle: "InstructionRa_4", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_4" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_5", oracle: "InstructionRa_5", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_5" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_6", oracle: "InstructionRa_6", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_6" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_7", oracle: "InstructionRa_7", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_7" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_8", oracle: "InstructionRa_8", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_8" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_9", oracle: "InstructionRa_9", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_9" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_10", oracle: "InstructionRa_10", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_10" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_11", oracle: "InstructionRa_11", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_11" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_12", oracle: "InstructionRa_12", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_12" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_13", oracle: "InstructionRa_13", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_13" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_14", oracle: "InstructionRa_14", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_14" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_15", oracle: "InstructionRa_15", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_15" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_16", oracle: "InstructionRa_16", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_16" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_17", oracle: "InstructionRa_17", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_17" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_18", oracle: "InstructionRa_18", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_18" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_19", oracle: "InstructionRa_19", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_19" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_20", oracle: "InstructionRa_20", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_20" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_21", oracle: "InstructionRa_21", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_21" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_22", oracle: "InstructionRa_22", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_22" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_23", oracle: "InstructionRa_23", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_23" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_24", oracle: "InstructionRa_24", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_24" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_25", oracle: "InstructionRa_25", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_25" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_26", oracle: "InstructionRa_26", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_26" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_27", oracle: "InstructionRa_27", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_27" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_28", oracle: "InstructionRa_28", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_28" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_29", oracle: "InstructionRa_29", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_29" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_30", oracle: "InstructionRa_30", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_30" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.InstructionRa_31", oracle: "InstructionRa_31", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.InstructionRa_31" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.BytecodeRa_0", oracle: "BytecodeRa_0", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.BytecodeRa_0" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.BytecodeRa_1", oracle: "BytecodeRa_1", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.BytecodeRa_1" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.BytecodeRa_2", oracle: "BytecodeRa_2", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.BytecodeRa_2" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.RamRa_0", oracle: "RamRa_0", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.RamRa_0" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.RamRa_1", oracle: "RamRa_1", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.RamRa_1" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.RamRa_2", oracle: "RamRa_2", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.RamRa_2" },
    Stage6OpeningClaimPlan { symbol: "stage6.booleanity.opening.RamRa_3", oracle: "RamRa_3", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.booleanity.instance", eval_source: "stage6.booleanity.eval.RamRa_3" },
    Stage6OpeningClaimPlan { symbol: "stage6.hamming_booleanity.opening.HammingWeight", oracle: "HammingWeight", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Virtual, point_source: "stage6.hamming_booleanity.instance", eval_source: "stage6.hamming_booleanity.eval.HammingWeight" },
    Stage6OpeningClaimPlan { symbol: "stage6.ram_ra_virtual.opening.RamRa_0", oracle: "RamRa_0", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.ram_ra_virtual.point.RamRa_0", eval_source: "stage6.ram_ra_virtual.eval.RamRa_0" },
    Stage6OpeningClaimPlan { symbol: "stage6.ram_ra_virtual.opening.RamRa_1", oracle: "RamRa_1", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.ram_ra_virtual.point.RamRa_1", eval_source: "stage6.ram_ra_virtual.eval.RamRa_1" },
    Stage6OpeningClaimPlan { symbol: "stage6.ram_ra_virtual.opening.RamRa_2", oracle: "RamRa_2", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.ram_ra_virtual.point.RamRa_2", eval_source: "stage6.ram_ra_virtual.eval.RamRa_2" },
    Stage6OpeningClaimPlan { symbol: "stage6.ram_ra_virtual.opening.RamRa_3", oracle: "RamRa_3", domain: "jolt.main_witness_commit_domain", point_arity: 20, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.ram_ra_virtual.point.RamRa_3", eval_source: "stage6.ram_ra_virtual.eval.RamRa_3" },
    ...
    Stage6OpeningClaimPlan { symbol: "stage6.inc_claim_reduction.opening.RamInc", oracle: "RamInc", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.inc_claim_reduction.instance", eval_source: "stage6.inc_claim_reduction.eval.RamInc" },
    Stage6OpeningClaimPlan { symbol: "stage6.inc_claim_reduction.opening.RdInc", oracle: "RdInc", domain: "jolt.trace_domain", point_arity: 16, claim_kind: Stage6ClaimKind::Committed, point_source: "stage6.inc_claim_reduction.instance", eval_source: "stage6.inc_claim_reduction.eval.RdInc" },
];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_0_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_1_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_2_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_3_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_4_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_5_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_6_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_7_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_8_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_9_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_10_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_11_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_13_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_15_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_21_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_25_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_26_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_28_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_29_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_32_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_33_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_34_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_35_FACTORS: &[&str] = &["stage6.booleanity.output.eq.InstructionRa0"];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERMS: &[bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan] = &[
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 0, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_0", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_0_FACTORS },
    ...
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 4, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_2", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_2_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 6, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_3", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_3_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 8, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_4", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_4_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 10, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_5", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_5_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 12, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_6", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_6_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 14, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_7", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_7_FACTORS },
    ...
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 18, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_9", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_9_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 20, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_10", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_10_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 22, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_11", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_11_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 24, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_12", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_12_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 26, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_13", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_13_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 28, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_14", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_14_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 30, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_15", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_15_FACTORS },
    ...
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 36, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_18", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_18_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 38, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_19", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_19_FACTORS },
    ...
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 42, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_21", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_21_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 44, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_22", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_22_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 46, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_23", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_23_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 48, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_24", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_24_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 50, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_25", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_25_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 52, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_26", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_26_FACTORS },
    ...
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 58, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_29", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_29_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 60, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_30", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_30_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 62, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.InstructionRa_31", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_31_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 64, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.BytecodeRa_0", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_32_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 66, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.BytecodeRa_1", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_33_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 68, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.BytecodeRa_2", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_34_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 70, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.RamRa_0", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_35_FACTORS },
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 72, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.booleanity.eval.RamRa_1", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILY_0_TERM_36_FACTORS },
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_1_FUNCTION_FAMILY_0_TERM_0_FACTORS: &[&str] = &["stage6.hamming_booleanity.output.eq.LookupOutput"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_1_FUNCTION_FAMILY_0_TERMS: &[bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan] = &[
    bolt_verifier_runtime::SumcheckOutputFunctionFamilyTermPlan { gamma_power_offset: 0, function: bolt_verifier_runtime::SumcheckOutputFunctionKind::BooleanZero, eval: "stage6.hamming_booleanity.eval.HammingWeight", factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_1_FUNCTION_FAMILY_0_TERM_0_FACTORS },
];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_2_PRODUCT_FAMILY_0_TERM_0_EVALS: &[&str] = &["stage6.ram_ra_virtual.eval.RamRa_0", "stage6.ram_ra_virtual.eval.RamRa_1", "stage6.ram_ra_virtual.eval.RamRa_2", "stage6.ram_ra_virtual.eval.RamRa_3"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_2_PRODUCT_FAMILY_0_TERM_0_FACTORS: &[&str] = &["stage6.ram_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_2_PRODUCT_FAMILY_0_TERMS: &[bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan] = &[
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 0, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_2_PRODUCT_FAMILY_0_TERM_0_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_2_PRODUCT_FAMILY_0_TERM_0_FACTORS },
];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_0_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_0", "stage6.instruction_ra_virtual.eval.InstructionRa_1", "stage6.instruction_ra_virtual.eval.InstructionRa_2", "stage6.instruction_ra_virtual.eval.InstructionRa_3"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_0_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_1_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_4", "stage6.instruction_ra_virtual.eval.InstructionRa_5", "stage6.instruction_ra_virtual.eval.InstructionRa_6", "stage6.instruction_ra_virtual.eval.InstructionRa_7"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_1_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_2_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_8", "stage6.instruction_ra_virtual.eval.InstructionRa_9", "stage6.instruction_ra_virtual.eval.InstructionRa_10", "stage6.instruction_ra_virtual.eval.InstructionRa_11"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_2_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_3_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_12", "stage6.instruction_ra_virtual.eval.InstructionRa_13", "stage6.instruction_ra_virtual.eval.InstructionRa_14", "stage6.instruction_ra_virtual.eval.InstructionRa_15"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_3_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_4_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_16", "stage6.instruction_ra_virtual.eval.InstructionRa_17", "stage6.instruction_ra_virtual.eval.InstructionRa_18", "stage6.instruction_ra_virtual.eval.InstructionRa_19"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_4_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_5_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_20", "stage6.instruction_ra_virtual.eval.InstructionRa_21", "stage6.instruction_ra_virtual.eval.InstructionRa_22", "stage6.instruction_ra_virtual.eval.InstructionRa_23"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_5_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_6_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_24", "stage6.instruction_ra_virtual.eval.InstructionRa_25", "stage6.instruction_ra_virtual.eval.InstructionRa_26", "stage6.instruction_ra_virtual.eval.InstructionRa_27"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_6_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_7_EVALS: &[&str] = &["stage6.instruction_ra_virtual.eval.InstructionRa_28", "stage6.instruction_ra_virtual.eval.InstructionRa_29", "stage6.instruction_ra_virtual.eval.InstructionRa_30", "stage6.instruction_ra_virtual.eval.InstructionRa_31"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_7_FACTORS: &[&str] = &["stage6.instruction_ra_virtual.output.eq.Cycle"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERMS: &[bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan] = &[
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 0, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_0_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_0_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 1, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_1_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_1_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 2, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_2_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_2_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 3, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_3_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_3_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 4, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_4_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_4_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 5, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_5_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_5_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 6, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_6_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_6_FACTORS },
    bolt_verifier_runtime::SumcheckOutputProductFamilyTermPlan { gamma_power_offset: 7, evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_7_EVALS, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_3_PRODUCT_FAMILY_0_TERM_7_FACTORS },
];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILY_0_VALUE_TERM_OFFSETS: &[usize] = &[];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILY_0_ITEM_TERM_0_FACTORS: &[&str] = &["stage6.inc_claim_reduction.output.eq.RamIncStage2", "stage6.inc_claim_reduction.output.eq.RdIncStage4"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILY_0_ITEM_TERM_1_FACTORS: &[&str] = &["stage6.inc_claim_reduction.output.eq.RamIncStage4", "stage6.inc_claim_reduction.output.eq.RdIncStage5"];
pub const STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILY_0_ITEM_TERMS: &[bolt_verifier_runtime::SumcheckOutputEvalFamilyItemTermPlan] = &[
    bolt_verifier_runtime::SumcheckOutputEvalFamilyItemTermPlan { gamma_power_offset: 0, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILY_0_ITEM_TERM_0_FACTORS },
    bolt_verifier_runtime::SumcheckOutputEvalFamilyItemTermPlan { gamma_power_offset: 1, factors: STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILY_0_ITEM_TERM_1_FACTORS },
];
...
pub const STAGE6_SUMCHECK_OUTPUT_CLAIMS: &[Stage6SumcheckOutputClaimPlan] = &[
    Stage6SumcheckOutputClaimPlan { relation: Stage6RelationKind::Stage6Booleanity, polynomial_evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_VALUES, eval_families: &[], product_families: &[], function_families: STAGE6_SUMCHECK_OUTPUT_CLAIM_0_FUNCTION_FAMILIES, local_scalars: &[], claim_value: "stage6.booleanity.output.family" },
    Stage6SumcheckOutputClaimPlan { relation: Stage6RelationKind::Stage6HammingBooleanity, polynomial_evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_1_VALUES, eval_families: &[], product_families: &[], function_families: STAGE6_SUMCHECK_OUTPUT_CLAIM_1_FUNCTION_FAMILIES, local_scalars: &[], claim_value: "stage6.hamming_booleanity.output.family" },
    Stage6SumcheckOutputClaimPlan { relation: Stage6RelationKind::Stage6RamRaVirtual, polynomial_evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_2_VALUES, eval_families: &[], product_families: STAGE6_SUMCHECK_OUTPUT_CLAIM_2_PRODUCT_FAMILIES, function_families: &[], local_scalars: &[], claim_value: "stage6.ram_ra_virtual.output.family" },
    ...
    Stage6SumcheckOutputClaimPlan { relation: Stage6RelationKind::Stage6IncClaimReduction, polynomial_evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_4_VALUES, eval_families: STAGE6_SUMCHECK_OUTPUT_CLAIM_4_FAMILIES, product_families: &[], function_families: &[], local_scalars: &[], claim_value: "stage6.inc_claim_reduction.output.family" },
    Stage6SumcheckOutputClaimPlan { relation: Stage6RelationKind::Stage6BytecodeReadRaf, polynomial_evals: STAGE6_SUMCHECK_OUTPUT_CLAIM_5_VALUES, eval_families: &[], product_families: STAGE6_SUMCHECK_OUTPUT_CLAIM_5_PRODUCT_FAMILIES, function_families: &[], local_scalars: STAGE6_SUMCHECK_OUTPUT_CLAIM_5_LOCAL_SCALARS, claim_value: "stage6.bytecode_read_raf.output.product.BytecodeReadRaf" },
];
