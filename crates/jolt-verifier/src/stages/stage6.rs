...
pub const STAGE6_RELATION_OUTPUTS: &[Stage6RelationOutputPlan] = &[
    Stage6RelationOutputPlan { relation: Stage6RelationKind::Stage6Booleanity, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage6.booleanity.output.eq.InstructionRa0", index: 0 }], eval_families: &[], product_families: &[], function_families: STAGE6_RELATION_OUTPUT_0_FUNCTION_FAMILIES, local_scalars: &[], expected_output: "stage6.booleanity.output.family" },
    Stage6RelationOutputPlan { relation: Stage6RelationKind::Stage6HammingBooleanity, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage6.hamming_booleanity.output.eq.LookupOutput", index: 1 }], eval_families: &[], product_families: &[], function_families: STAGE6_RELATION_OUTPUT_1_FUNCTION_FAMILIES, local_scalars: &[], expected_output: "stage6.hamming_booleanity.output.family" },
    Stage6RelationOutputPlan { relation: Stage6RelationKind::Stage6RamRaVirtual, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage6.ram_ra_virtual.output.eq.Cycle", index: 2 }], eval_families: &[], product_families: STAGE6_RELATION_OUTPUT_2_PRODUCT_FAMILIES, function_families: &[], local_scalars: &[], expected_output: "stage6.ram_ra_virtual.output.family" },
    Stage6RelationOutputPlan { relation: Stage6RelationKind::Stage6InstructionRaVirtual, structured_polynomial_evals: &[bolt_verifier_runtime::StructuredPolynomialEvalRef { symbol: "stage6.instruction_ra_virtual.output.eq.Cycle", index: 3 }], eval_families: &[], product_families: STAGE6_RELATION_OUTPUT_3_PRODUCT_FAMILIES, function_families: &[], local_scalars: &[], expected_output: "stage6.instruction_ra_virtual.output.family" },
