...
//!
//! The fixtures are generated by the real ZK prover; the advice-consumer
//! fixture exercises the BlindFold advice-reconstruction constraints
//! (trusted/untrusted `FinalScale`, `ByteDecode`). Every non-skipped input
//! changes one committed-sumcheck, final-opening, BlindFold, program-binding,
//! or advice component and requires the compiled ZK verifier to reject it.
...
static FIXTURES: [&[u8]; 3] = [
    ...
    include_bytes!("../fixtures/zk-advice-consumer-bundle.bin"),
];
...
fuzz_target!(|data: &[u8]| {
    ...
    let changed = match mutation {
        // Shape guard, not a soundness probe: ZK claims under a Transparent
