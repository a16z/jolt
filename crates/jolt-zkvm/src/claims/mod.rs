...
//! function returns a [`jolt_ir::ClaimDefinition`] encoding the mathematical
//! formula as a symbolic expression. These definitions are the **single
//! source of truth** — evaluation, BlindFold R1CS, Lean4, and circuit
