...
pub struct Executable<P: PolyId, B: ComputeBackend, F: Field> {
...
pub fn link<P: PolyId, B: ComputeBackend, F: Field>(
    module: Module<P>,
    backend: &B,
) -> Executable<P, B, F> {
...
impl<P: PolyId, B: ComputeBackend, F: Field> Executable<P, B, F> {
    #[inline]
