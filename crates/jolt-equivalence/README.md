...
the dedicated Bolt perf workflow. Both workflows run on stacked PRs as well as
`main` PRs, because the modular crate stack needs the same core-backed harness
coverage before its base branches land.
