...
use jolt_core::zkvm::r1cs::constraints::{
    ...
    OUTER_UNIVARIATE_SKIP_DOMAIN_SIZE, NUM_R1CS_CONSTRAINTS,
...
fn confirm_uniskip_constants() {
    ...
    eprintln!("OUTER_UNIVARIATE_SKIP_DEGREE = {}", OUTER_UNIVARIATE_SKIP_DEGREE);
    eprintln!("OUTER_UNIVARIATE_SKIP_DOMAIN_SIZE = {}", OUTER_UNIVARIATE_SKIP_DOMAIN_SIZE);
    eprintln!("OUTER_FIRST_ROUND_POLY_NUM_COEFFS = {}", OUTER_FIRST_ROUND_POLY_NUM_COEFFS);
    eprintln!("NUM_REMAINING_R1CS_CONSTRAINTS = {}", NUM_REMAINING_R1CS_CONSTRAINTS);
