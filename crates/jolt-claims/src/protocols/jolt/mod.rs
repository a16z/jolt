...
pub use formulas::{
    ...
    lattice::{
        ...
        fused_increment_inactive_source_link_relation, fused_increment_inactive_source_opening,
        fused_increment_inactive_zero_claim, fused_increment_inactive_zero_output_openings,
        fused_increment_inactive_zero_relation, fused_increment_magnitude_lattice_view_formula,
...
pub use ids::{
    ...
    BytecodeReadRafPublic, FusedIncrementInactiveSourceLinkChallenge,
    FusedIncrementInactiveZeroChallenge, FusedIncrementSourceLinkChallenge,
    FusedIncrementTranslationChallenge, HammingWeightClaimReductionChallenge,
