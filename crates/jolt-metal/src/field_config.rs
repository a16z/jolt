//! Runtime Montgomery field parameterization for Metal shader codegen.
//!
//! [`MslFieldParams`] validates safety invariants at construction time and
...
impl MslFieldParams {
    /// Construct validated [`MslFieldParams`] from a [`MontgomeryConstants`] implementation.
    ///
    /// # Panics
    ///
    /// Panics if:
    ...
    pub fn new<F: MontgomeryConstants>() -> Self {
...
mod tests {
    ...
    #[test]
    fn bn254_field_params_validates() {
        let config = MslFieldParams::new::<Fr>();
