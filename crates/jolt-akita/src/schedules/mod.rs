...
mod jolt_fp128_onehot_k256_metal;
...
/// The K=256 large-trace catalog used by the Metal commitment path.
pub fn jolt_fp128_onehot_k256_metal_table() -> Option<GeneratedScheduleTable> {
    Some(GeneratedScheduleTable {
        entries: jolt_fp128_onehot_k256_metal::JOLT_FP128_ONEHOT_K256_SCHEDULES,
        identity: jolt_fp128_onehot_k256_metal::CATALOG_IDENTITY,
    })
}
...
pub mod emit {
    ...
    use crate::configs::{JoltDenseBounded, JoltOneHotK16, JoltOneHotK256Cpu, JoltOneHotK256Metal};
    ...
    pub fn family_specs(output_dir: PathBuf) -> Result<[EmitSpec; 4], AkitaError> {
        Ok([
            ...
            spec::<JoltOneHotK256Metal>(
                "jolt_fp128_onehot_k256_metal",
                "JOLT_FP128_ONEHOT_K256_SCHEDULES",
                "jolt-fp128-onehot-k256",
                ONE_HOT_TRACE_NUM_POLYS,
                K256_NUM_VARS,
