...
delegate_preset!(
    ...
    <akita_config::proof_optimized::fp128::OneHot as CommitmentConfig>::RING_DIMENSION_SCHEDULE_MODE,
...
delegate_preset!(
    ...
    <akita_config::proof_optimized::fp128::OneHot as CommitmentConfig>::committed_source_class(),
...
delegate_preset!(
    ...
    <akita_config::proof_optimized::fp128::Dense as CommitmentConfig>::RING_DIMENSION_SCHEDULE_MODE,
    <akita_config::proof_optimized::fp128::Dense as CommitmentConfig>::committed_source_class(),
...
mod tests {
    ...
    fn k256_policy_uses_adaptive_dimensions() {
        assert_eq!(
            JoltOneHotK256::committed_source_class(),
            akita_types::sis::CommittedSourceClass::UnitOneHot {
