use jolt_openings::{
    BatchOpeningResult, BatchOpeningStatement, CommitmentScheme, OpeningsError,
...
use crate::{
    native::{field_bytes, transparent_zk_error},
    scheme::AkitaScheme,
    types::{append_field_slice, AkitaHidingCommitment},
};
