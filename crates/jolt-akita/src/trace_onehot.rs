...
use jolt_field::{CanonicalEncoding, ExtField, One, PseudoMersenne, Unreduced, Zero};
use rayon::prelude::*;
...
type AkitaWideRing<const D: usize> = WideCyclotomicRing<<AkitaField as Unreduced>::Wide, D>;
