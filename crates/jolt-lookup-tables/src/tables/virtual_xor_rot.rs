...
mod tests {
    ...
    /// One `mle_random`, `prefix_suffix`, and 8-bit exhaustive hypercube test
    /// per Keccak rho-fusion rotation amount.
    macro_rules! keccak_xor_rot_tests {
        ($($n:literal => ($random:ident, $ps:ident, $cube:ident)),+ $(,)?) => {
            $(
                #[test]
                fn $random() {
                ...
                #[test]
                fn $cube() {
                    mle_full_hypercube_test::<8, Fr, VirtualXORROTTable<8, $n>>();
                }
            )+
        };
    }
    ...
    keccak_xor_rot_tests!(
        2 => (mle_random_rot2, prefix_suffix_rot2, mle_full_hypercube_rot2),
        3 => (mle_random_rot3, prefix_suffix_rot3, mle_full_hypercube_rot3),
        8 => (mle_random_rot8, prefix_suffix_rot8, mle_full_hypercube_rot8),
        9 => (mle_random_rot9, prefix_suffix_rot9, mle_full_hypercube_rot9),
        19 => (mle_random_rot19, prefix_suffix_rot19, mle_full_hypercube_rot19),
        20 => (mle_random_rot20, prefix_suffix_rot20, mle_full_hypercube_rot20),
        21 => (mle_random_rot21, prefix_suffix_rot21, mle_full_hypercube_rot21),
        23 => (mle_random_rot23, prefix_suffix_rot23, mle_full_hypercube_rot23),
        25 => (mle_random_rot25, prefix_suffix_rot25, mle_full_hypercube_rot25),
        28 => (mle_random_rot28, prefix_suffix_rot28, mle_full_hypercube_rot28),
        36 => (mle_random_rot36, prefix_suffix_rot36, mle_full_hypercube_rot36),
        37 => (mle_random_rot37, prefix_suffix_rot37, mle_full_hypercube_rot37),
        39 => (mle_random_rot39, prefix_suffix_rot39, mle_full_hypercube_rot39),
        43 => (mle_random_rot43, prefix_suffix_rot43, mle_full_hypercube_rot43),
        44 => (mle_random_rot44, prefix_suffix_rot44, mle_full_hypercube_rot44),
        46 => (mle_random_rot46, prefix_suffix_rot46, mle_full_hypercube_rot46),
        49 => (mle_random_rot49, prefix_suffix_rot49, mle_full_hypercube_rot49),
        50 => (mle_random_rot50, prefix_suffix_rot50, mle_full_hypercube_rot50),
        54 => (mle_random_rot54, prefix_suffix_rot54, mle_full_hypercube_rot54),
        56 => (mle_random_rot56, prefix_suffix_rot56, mle_full_hypercube_rot56),
        58 => (mle_random_rot58, prefix_suffix_rot58, mle_full_hypercube_rot58),
        61 => (mle_random_rot61, prefix_suffix_rot61, mle_full_hypercube_rot61),
        62 => (mle_random_rot62, prefix_suffix_rot62, mle_full_hypercube_rot62),
    );
