...
impl<const XLEN: usize> LookupTable for VirtualROTRWTable<XLEN> {
...
mod tests {
    ...
    #[test]
    fn mle_random() {
        mle_random_test::<XLEN, Fr, VirtualROTRWTable<XLEN>>();
    }
    ...
    fn mle_full_hypercube() {
        mle_full_hypercube_test::<8, Fr, VirtualROTRWTable<8>>();
    }
}
