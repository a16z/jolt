...
pub struct VirtualROTRTable;

impl LookupTable for VirtualROTRTable {
...
impl PrefixSuffixDecomposition for VirtualROTRTable {
...
mod tests {
    ...
    #[test]
    fn mle_random() {
        mle_random_test::<Fr, VirtualROTRTable>();
    }

    #[test]
    fn prefix_suffix() {
        prefix_suffix_test::<Fr, VirtualROTRTable>();
    }
}
