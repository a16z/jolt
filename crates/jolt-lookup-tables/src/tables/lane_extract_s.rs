...
impl<const XLEN: usize> LookupTable for LaneExtractSTable<XLEN> {
...
mod tests {
    ...
    use crate::tables::test_utils::{
        index_to_field_bitvector, mle_full_hypercube_test, prefix_suffix_test,
    };
    use crate::XLEN;
    ...
    fn mle_full_hypercube() {
        mle_full_hypercube_test::<8, Fr, LaneExtractSTable<8>>();
    }
