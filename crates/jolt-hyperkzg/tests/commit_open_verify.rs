...
fn commit_open_verify(
    ...
    <KzgPCS as CommitmentSchemeVerifier>::verify(&commitment, point, eval, &proof, vk, &mut t_v)
...
fn wrong_eval_rejected() {
    ...
    let result = <KzgPCS as CommitmentSchemeVerifier>::verify(
        &commitment,
        &point,
        wrong_eval,
        &proof,
...
fn homomorphic_sum() {
    ...
    <KzgPCS as CommitmentSchemeVerifier>::verify(
        &combined_com,
        &point,
        eval,
        &proof,
...
fn deterministic_setup_from_secret() {
    ...
    let mut t = Blake2bTranscript::new(b"det-setup");
    <KzgPCS as CommitmentSchemeVerifier>::verify(&com1, &point, eval, &proof, &vk2, &mut t)
